...
-- Sweden +1 food/+1 production yield to city centers on desert/tundra/snow tiles after feudalism
INSERT OR IGNORE INTO TraitModifiers (TraitType, ModifierId) VALUES
    ...
    ('TRAIT_CIVILIZATION_NOBEL_PRIZE', 'BBG_SWEDEN_CITY_CENTERS_BONUS_YIELD_FOOD'),
    ('TRAIT_CIVILIZATION_NOBEL_PRIZE', 'BBG_SWEDEN_CITY_CENTERS_BONUS_YIELD_PRODUCTION');
...
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
    ('BBG_SWEDEN_CITY_CENTERS_BONUS_YIELD_FOOD', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE', 'BBG_UTILS_PLAYER_HAS_CIVIC_FEUDALISM_REQSET', 'BBG_TILE_IS_DESERT_TUNDRA_SNOW'),
    ('BBG_SWEDEN_CITY_CENTERS_BONUS_YIELD_PRODUCTION', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE', 'BBG_UTILS_PLAYER_HAS_CIVIC_FEUDALISM_REQSET', 'BBG_TILE_IS_DESERT_TUNDRA_SNOW');
INSERT OR IGNORE INTO ModifierArguments (ModifierId, Name, Value) VALUES 
    ...
    ('BBG_SWEDEN_CITY_CENTERS_BONUS_YIELD_FOOD', 'YieldType', 'YIELD_FOOD'),
    ('BBG_SWEDEN_CITY_CENTERS_BONUS_YIELD_FOOD', 'Amount', 1),
    ('BBG_SWEDEN_CITY_CENTERS_BONUS_YIELD_PRODUCTION', 'YieldType', 'YIELD_PRODUCTION'),
    ('BBG_SWEDEN_CITY_CENTERS_BONUS_YIELD_PRODUCTION', 'Amount', 1);
