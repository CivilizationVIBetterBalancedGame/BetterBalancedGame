...
--07/08/26 also tier 3 buildings
...
INSERT OR IGNORE INTO TraitModifiers (TraitType, ModifierId) VALUES
    ('TRAIT_CIVILIZATION_NOBEL_PRIZE', 'BBG_SWEDEN_CAMPUS_BUILDINGS_PRODUCTION'),
    ('TRAIT_CIVILIZATION_NOBEL_PRIZE', 'BBG_SWEDEN_INDUSTRIAL_BUILDINGS_PRODUCTION');

INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType) VALUES
    ('BBG_SWEDEN_CAMPUS_BUILDINGS_PRODUCTION', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION'),
    ('BBG_SWEDEN_INDUSTRIAL_BUILDINGS_PRODUCTION', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION');

INSERT OR IGNORE INTO ModifierArguments (ModifierId, Name, Value) VALUES 
    ('BBG_SWEDEN_CAMPUS_BUILDINGS_PRODUCTION', 'DistrictType', 'DISTRICT_CAMPUS'),
    ('BBG_SWEDEN_CAMPUS_BUILDINGS_PRODUCTION', 'Amount', 50),
    ('BBG_SWEDEN_INDUSTRIAL_BUILDINGS_PRODUCTION', 'DistrictType', 'DISTRICT_INDUSTRIAL_ZONE'),
    ('BBG_SWEDEN_INDUSTRIAL_BUILDINGS_PRODUCTION', 'Amount', 50);
...
-- 18/01/26 also for engineer and scientist 2/tiers
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ...
    ('BBG_KRISTINA_SCIENTISTS_GIVER_T1', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', NULL),
    ('BBG_KRISTINA_SCIENTISTS_T1', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BBG_CITY_HAS_T1_BUILDING'),
    ('BBG_KRISTINA_SCIENTISTS_GIVER_T2', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', NULL),
    ('BBG_KRISTINA_SCIENTISTS_T2', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BBG_CITY_HAS_T2_BUILDING'), 
    ('BBG_KRISTINA_SCIENTISTS_GIVER_T3', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', NULL),
    ('BBG_KRISTINA_SCIENTISTS_T3', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BBG_CITY_HAS_T3_BUILDING'),
    ('BBG_KRISTINA_ENGINEERS_GIVER_T1', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', NULL),
    ('BBG_KRISTINA_ENGINEERS_T1', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BBG_CITY_HAS_T1_BUILDING'),
    ('BBG_KRISTINA_ENGINEERS_GIVER_T2', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', NULL),
    ('BBG_KRISTINA_ENGINEERS_T2', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BBG_CITY_HAS_T2_BUILDING'), 
    ('BBG_KRISTINA_ENGINEERS_GIVER_T3', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', NULL),
    ('BBG_KRISTINA_ENGINEERS_T3', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BBG_CITY_HAS_T3_BUILDING'); 
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ...
    ('BBG_KRISTINA_SCIENTISTS_GIVER_T1', 'ModifierId', 'BBG_KRISTINA_SCIENTISTS_T1'),
    ('BBG_KRISTINA_SCIENTISTS_T1', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_SCIENTIST'),
    ('BBG_KRISTINA_SCIENTISTS_T1', 'Amount', 2),
    ('BBG_KRISTINA_SCIENTISTS_GIVER_T2', 'ModifierId', 'BBG_KRISTINA_SCIENTISTS_T2'),
    ('BBG_KRISTINA_SCIENTISTS_T2', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_SCIENTIST'),
    ('BBG_KRISTINA_SCIENTISTS_T2', 'Amount', 2),
    ('BBG_KRISTINA_SCIENTISTS_GIVER_T3', 'ModifierId', 'BBG_KRISTINA_SCIENTISTS_T3'),
    ('BBG_KRISTINA_SCIENTISTS_T3', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_SCIENTIST'),
    ('BBG_KRISTINA_SCIENTISTS_T3', 'Amount', 2),
    ('BBG_KRISTINA_ENGINEERS_GIVER_T1', 'ModifierId', 'BBG_KRISTINA_ENGINEERS_T1'),
    ('BBG_KRISTINA_ENGINEERS_T1', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ENGINEER'),
    ('BBG_KRISTINA_ENGINEERS_T1', 'Amount', 2),
    ('BBG_KRISTINA_ENGINEERS_GIVER_T2', 'ModifierId', 'BBG_KRISTINA_ENGINEERS_T2'),
    ('BBG_KRISTINA_ENGINEERS_T2', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ENGINEER'),
    ('BBG_KRISTINA_ENGINEERS_T2', 'Amount', 2),
    ('BBG_KRISTINA_ENGINEERS_GIVER_T3', 'ModifierId', 'BBG_KRISTINA_ENGINEERS_T3'),
    ('BBG_KRISTINA_ENGINEERS_T3', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ENGINEER'),
    ('BBG_KRISTINA_ENGINEERS_T3', 'Amount', 2);
...
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ...
    ('TRAIT_LEADER_BUILDING_QUEENS_BIBLIOTHEQUE', 'BBG_KRISTINA_SCIENTISTS_GIVER_T1'),
    ('TRAIT_LEADER_BUILDING_QUEENS_BIBLIOTHEQUE', 'BBG_KRISTINA_SCIENTISTS_GIVER_T2'),
    ('TRAIT_LEADER_BUILDING_QUEENS_BIBLIOTHEQUE', 'BBG_KRISTINA_SCIENTISTS_GIVER_T3'),
    ('TRAIT_LEADER_BUILDING_QUEENS_BIBLIOTHEQUE', 'BBG_KRISTINA_ENGINEERS_GIVER_T1'),
    ('TRAIT_LEADER_BUILDING_QUEENS_BIBLIOTHEQUE', 'BBG_KRISTINA_ENGINEERS_GIVER_T2'),
