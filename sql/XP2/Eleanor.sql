...
-- 02/01/25 Reverted
-- 16/03/26 Reverted again - Eleanor have +20% towards classical and ancient wonders
INSERT INTO RequirementSets(RequirementSetId , RequirementSetType) VALUES
...
-- 19/12/25 gets 1 writer point if the city has a market/lighthouse/temple
-- 02/01/26 Removed market
-- 16/03/26 Reverted to no GPP
-- INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
--     ('BUILDING_IS_LIGHTHOUSE_TEMPLE_REQSET', 'REQUIREMENTSET_TEST_ANY');
-- INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
--     ('BUILDING_IS_LIGHTHOUSE_TEMPLE_REQSET', 'REQUIRES_CITY_HAS_TEMPLE'),
--     ('BUILDING_IS_LIGHTHOUSE_TEMPLE_REQSET', 'REQUIRES_CITY_HAS_LIGHTHOUSE');
--     -- ('BUILDING_IS_LIGHTHOUSE_MARKET_TEMPLE_REQSET', 'REQUIRES_CITY_HAS_MARKET');
-- INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
--     ('BBG_WRITER_LIGHTHOUSE_TEMPLE_DOCKYARD_GIVER', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', NULL),
--     ('BBG_WRITER_LIGHTHOUSE_TEMPLE_DOCKYARD', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BUILDING_IS_LIGHTHOUSE_TEMPLE_REQSET');
-- INSERT INTO ModifierArguments (ModifierId , Name , Value) VALUES
--     ('BBG_WRITER_LIGHTHOUSE_TEMPLE_DOCKYARD_GIVER', 'ModifierId', 'BBG_WRITER_LIGHTHOUSE_TEMPLE_DOCKYARD'),
--     ('BBG_WRITER_LIGHTHOUSE_TEMPLE_DOCKYARD', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_WRITER'),
--     ('BBG_WRITER_LIGHTHOUSE_TEMPLE_DOCKYARD', 'Amount', 1);
-- INSERT INTO TraitModifiers(TraitType, ModifierId) VALUES
--     ('TRAIT_LEADER_ELEANOR_LOYALTY', 'BBG_WRITER_LIGHTHOUSE_TEMPLE_DOCKYARD_GIVER');