...
--14/07/26 Great Bath : +1 food to all floodplains in the city
--18/09/26 recreate the requirements to no longer depends on the portugal pack (etemenanki)
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_PLOT_HAS_PLAINS_FLOODPLAINS_REQUIREMENTS', 'REQUIREMENTSET_TEST_ALL'),
    ('BBG_PLOT_HAS_GRASS_FLOODPLAINS_REQUIREMENTS', 'REQUIREMENTSET_TEST_ALL'),
    ('BBG_PLOT_HAS_FLOODPLAINS_REQUIREMENTS', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_PLOT_HAS_PLAINS_FLOODPLAINS_REQUIREMENTS', 'REQUIRES_PLOT_HAS_PLAINS_FLOODPLAINS'),
    ('BBG_PLOT_HAS_GRASS_FLOODPLAINS_REQUIREMENTS', 'REQUIRES_PLOT_HAS_GRASS_FLOODPLAINS'),
    ('BBG_PLOT_HAS_FLOODPLAINS_REQUIREMENTS', 'REQUIRES_PLOT_HAS_FLOODPLAINS');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_GREAT_BATH_FOOD_PLAINS_FLOODPLAINS', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 'BBG_PLOT_HAS_PLAINS_FLOODPLAINS_REQUIREMENTS'),
    ('BBG_GREAT_BATH_FOOD_GRASS_FLOODPLAINS', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 'BBG_PLOT_HAS_GRASS_FLOODPLAINS_REQUIREMENTS'),
    ('BBG_GREAT_BATH_FOOD_FLOODPLAINS', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 'BBG_PLOT_HAS_FLOODPLAINS_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_GREAT_BATH_FOOD_PLAINS_FLOODPLAINS', 'YieldType', 'YIELD_FOOD'),
    ('BBG_GREAT_BATH_FOOD_PLAINS_FLOODPLAINS', 'Amount', 1),
    ('BBG_GREAT_BATH_FOOD_GRASS_FLOODPLAINS', 'YieldType', 'YIELD_FOOD'),
    ('BBG_GREAT_BATH_FOOD_GRASS_FLOODPLAINS', 'Amount', 1),
    ('BBG_GREAT_BATH_FOOD_FLOODPLAINS', 'YieldType', 'YIELD_FOOD'),
    ('BBG_GREAT_BATH_FOOD_FLOODPLAINS', 'Amount', 1);
INSERT INTO BuildingModifiers (BuildingType, ModifierId) VALUES
    ('BUILDING_GREAT_BATH', 'BBG_GREAT_BATH_FOOD_PLAINS_FLOODPLAINS'),
    ('BUILDING_GREAT_BATH', 'BBG_GREAT_BATH_FOOD_GRASS_FLOODPLAINS'),
    ('BUILDING_GREAT_BATH', 'BBG_GREAT_BATH_FOOD_FLOODPLAINS');
