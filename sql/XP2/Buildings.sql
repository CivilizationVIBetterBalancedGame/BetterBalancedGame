...
-- 04/07/26 Seaport now give +1 coal / oil instead of +0/2
INSERT OR IGNORE INTO BuildingModifiers (BuildingType, ModifierId) VALUES
    ('BUILDING_SEAPORT', 'BBG_OIL_SEAPORT_BONUS'),
    ('BUILDING_SEAPORT', 'BBG_COAL_SEAPORT_BONUS');
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_OIL_SEAPORT_BONUS', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'BBG_PLAYER_CAN_SEE_RESOURCE_OIL_REQSET'),
    ('BBG_COAL_SEAPORT_BONUS', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'BBG_PLAYER_CAN_SEE_RESOURCE_COAL_REQSET');
INSERT OR IGNORE INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_OIL_SEAPORT_BONUS', 'ResourceType', 'RESOURCE_OIL'),
    ('BBG_OIL_SEAPORT_BONUS', 'Amount', '1'),
    ('BBG_COAL_SEAPORT_BONUS', 'ResourceType', 'RESOURCE_COAL'),
    ('BBG_COAL_SEAPORT_BONUS', 'Amount', '1');
