...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('HORSES_AMANI_AMOUNT_MODIFIER', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'BBG_PLAYER_CAN_SEE_RESOURCE_HORSES_REQSET'),
    ('IRON_AMANI_AMOUNT_MODIFIER', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'BBG_PLAYER_CAN_SEE_RESOURCE_IRON_REQSET'),
    ('NITER_AMANI_AMOUNT_MODIFIER', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'BBG_PLAYER_CAN_SEE_RESOURCE_NITER_REQSET'),
    ('COAL_AMANI_AMOUNT_MODIFIER', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'BBG_PLAYER_CAN_SEE_RESOURCE_COAL_REQSET'),
    ('ALUMINUM_AMANI_AMOUNT_MODIFIER', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'BBG_PLAYER_CAN_SEE_RESOURCE_ALUMINUM_REQSET'),
    ('OIL_AMANI_AMOUNT_MODIFIER', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'BBG_PLAYER_CAN_SEE_RESOURCE_OIL_REQSET'),
    ('URANIUM_AMANI_AMOUNT_MODIFIER', 'MODIFIER_PLAYER_ADJUST_FREE_RESOURCE_IMPORT_EXTRACTION', 'BBG_PLAYER_CAN_SEE_RESOURCE_URANIUM_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
...
-- 22/07/26 need improved or settled
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_LIANG_AGRICULTURE_FOOD_IMPROVED', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 'BBG_PLOT_HAS_IMPROVED_RESOURCE'),
    ('BBG_LIANG_AGRICULTURE_FOOD_CITYCENTER', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 'BBG_PLOT_HAS_SETTLED_RESOURCE');
    
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_LIANG_AGRICULTURE_FOOD_IMPROVED', 'YieldType', 'YIELD_FOOD'),
    ('BBG_LIANG_AGRICULTURE_FOOD_IMPROVED', 'Amount', '1'),
    ('BBG_LIANG_AGRICULTURE_FOOD_CITYCENTER', 'YieldType', 'YIELD_FOOD'),
    ('BBG_LIANG_AGRICULTURE_FOOD_CITYCENTER', 'Amount', '1');
...
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_PLOT_HAS_IMPROVED_RESOURCE', 'REQUIREMENTSET_TEST_ALL'),
    ('BBG_PLOT_HAS_SETTLED_RESOURCE', 'REQUIREMENTSET_TEST_ALL');

INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_PLOT_HAS_IMPROVED_RESOURCE', 'PLOT_HAS_RESOURCE_REQUIREMENTS'),
    ('BBG_PLOT_HAS_IMPROVED_RESOURCE', 'BBG_TILE_HAS_ANY_IMPROVEMENT'),
    ('BBG_PLOT_HAS_SETTLED_RESOURCE', 'PLOT_HAS_RESOURCE_REQUIREMENTS'),
    ('BBG_PLOT_HAS_SETTLED_RESOURCE', 'BBG_REQUIRES_PLOT_IS_CITY_CENTER');
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
    VALUES  ('BBG_AGRICULTURE_PROMOTION', 'BBG_LIANG_AGRICULTURE_FOOD_IMPROVED'),
            ('BBG_AGRICULTURE_PROMOTION', 'BBG_LIANG_AGRICULTURE_FOOD_CITYCENTER');
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_LIANG_PROD_RESOURCES_IMPROVED', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 'BBG_PLOT_HAS_IMPROVED_RESOURCE'),
    ('BBG_LIANG_PROD_RESOURCES_CITYCENTER', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 'BBG_PLOT_HAS_SETTLED_RESOURCE');

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_LIANG_PROD_RESOURCES_IMPROVED', 'YieldType', 'YIELD_PRODUCTION'),
    ('BBG_LIANG_PROD_RESOURCES_IMPROVED', 'Amount', 1),
    ('BBG_LIANG_PROD_RESOURCES_CITYCENTER', 'YieldType', 'YIELD_PRODUCTION'),
    ('BBG_LIANG_PROD_RESOURCES_CITYCENTER', 'Amount', 1);

INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES
    ('GOVERNOR_PROMOTION_ZONING_COMMISSIONER', 'BBG_LIANG_PROD_RESOURCES_IMPROVED'),
    ('GOVERNOR_PROMOTION_ZONING_COMMISSIONER', 'BBG_LIANG_PROD_RESOURCES_CITYCENTER');
