...
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ...
    ('BBG_PLAYER_IS_MALI_AND_DISTRICT_IS_ADJACENT_TO_OASIS', 'REQUIREMENTSET_TEST_ALL');
...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ...
    ('BBG_PLAYER_IS_MALI_AND_DISTRICT_IS_ADJACENT_TO_OASIS', 'BBG_PLAYER_IS_MALI'),
    ('BBG_PLAYER_IS_MALI_AND_DISTRICT_IS_ADJACENT_TO_OASIS', 'BBG_PLOT_IS_ADJACENT_TO_FEATURE_OASIS');
...
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
    ...
    ('BBG_PLOT_IS_ADJACENT_TO_FEATURE_OASIS', 'REQUIREMENT_PLOT_ADJACENT_FEATURE_TYPE_MATCHES');
...
-- Necessits X+1...
    ...
    ('BBG_PLOT_IS_ADJACENT_TO_FEATURE_OASIS', 'FeatureType', 'FEATURE_OASIS');
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_DESERT_PLOT_COST', 'MODIFIER_PLAYER_CITIES_ADJUST_PLOT_PURCHASE_COST_TERRAIN', null),
    ('BBG_DESERT_HILLS_PLOT_COST', 'MODIFIER_PLAYER_CITIES_ADJUST_PLOT_PURCHASE_COST_TERRAIN', null),
    ...
    ('BBG_MALI_HS_ADJACENT_BONUS_NEAR_OASIS', 'MODIFIER_PLAYER_DISTRICT_ADJUST_BASE_YIELD_CHANGE', 'BBG_PLAYER_IS_MALI_AND_DISTRICT_IS_ADJACENT_TO_OASIS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ...
    ('BBG_MALI_HS_ADJACENT_BONUS_NEAR_OASIS', 'Amount',   '1'),
    ('BBG_MALI_HS_ADJACENT_BONUS_NEAR_OASIS', 'YieldType',   'YIELD_FAITH');
INSERT INTO TraitModifiers(TraitType, ModifierId) VALUES
...
--27/03/24 Grant holy site +1 adjacent bonus if next to oasis (no matter how many oasis nearby)
    ('DISTRICT_HOLY_SITE', 'BBG_MALI_HS_ADJACENT_BONUS_NEAR_OASIS');
