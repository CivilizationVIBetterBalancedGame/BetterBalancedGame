...
DELETE FROM TraitModifiers WHERE ModifierId IN ('TRAIT_DESERT_CITY_CENTER_FOOD', 'TRAIT_MALI_MINES_PRODUCTION', 'TRAIT_MALI_MINES_GOLD');

-- 30/06/25 +2 faith per city center if on desert tile (or if capital)
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_MALI_FAITH_NEXT_DESERT', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE', 'BBG_CITY_DESERT_OR_CAPITAL_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_MALI_FAITH_NEXT_DESERT', 'YieldType', 'YIELD_FAITH'),
    ('BBG_MALI_FAITH_NEXT_DESERT', 'Amount', 2);
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_CITY_DESERT_OR_CAPITAL_REQSET', 'REQUIREMENTSET_TEST_ANY');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_CITY_DESERT_OR_CAPITAL_REQSET', 'REQUIRES_PLOT_HAS_DESERT'),
    ('BBG_CITY_DESERT_OR_CAPITAL_REQSET', 'REQUIRES_PLOT_HAS_DESERT_HILLS'),
    ('BBG_CITY_DESERT_OR_CAPITAL_REQSET', 'REQUIRES_CAPITAL_CITY');
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
