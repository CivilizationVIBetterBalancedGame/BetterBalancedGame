...
UPDATE Improvements
SET Description = 'LOC_IMPROVEMENT_MAORI_PA_DESCRIPTION_TCS_MOD'
...
--==============================
--DLC COMPATIBILITY TRIGGERS
--==============================
--Alcazar Improvement
--------------------------------
UPDATE Improvements
SET Description = 'LOC_IMPROVEMENT_ALCAZAR_DESCRIPTION_TCS_MOD_XP2'
WHERE ImprovementType = 'IMPROVEMENT_ALCAZAR'
AND EXISTS (SELECT * FROM Improvements WHERE ImprovementType = 'IMPROVEMENT_ALCAZAR');
