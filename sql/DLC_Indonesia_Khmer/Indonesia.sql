...
-- 19/01/26 Delayed to Sailing
UPDATE Modifiers SET OwnerRequirementSetId='BBG_UTILS_PLAYER_HAS_TECH_SAILING' WHERE ModifierId='TRAIT_FAITH_CITY_CENTER';
...
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
    ('BBG_FAITH_DISTRICT_INDO_BASE', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE', 'BBG_UTILS_PLAYER_HAS_TECH_SAILING', 'BBG_SPECIAL_DISTRICT_OR_CITY_CENTER_ON_COAST');
...
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
    ('BBG_FAITH_DISTRICT_INDO_SHIPBUILDING', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE', 'BBG_UTILS_PLAYER_HAS_TECH_SAILING', 'BBG_SPECIAL_DISTRICT_OR_CITY_CENTER_ON_COAST_SHIPBUILDING');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
