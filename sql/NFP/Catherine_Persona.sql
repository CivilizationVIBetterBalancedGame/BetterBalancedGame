...
-- Happy cities gain +5% Culture, and generate +1 Great Writer, Artist, and Musician point in their Theater. Ecstatic cities double these bonuses.
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ...
    ('BBG_MAGNIFICENT_WRITER_POINT_HAPPY', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'CITY_HAS_THEATER_DISTRICT_MACEDON'),
    ('BBG_MAGNIFICENT_WRITER_POINT_ECSTATIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'CITY_HAS_THEATER_DISTRICT_MACEDON'),
    ('BBG_MAGNIFICENT_ARTIST_POINT_HAPPY', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'CITY_HAS_THEATER_DISTRICT_MACEDON'),
    ('BBG_MAGNIFICENT_ARTIST_POINT_ECSTATIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'CITY_HAS_THEATER_DISTRICT_MACEDON'),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_HAPPY', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'CITY_HAS_THEATER_DISTRICT_MACEDON'),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_ECSTATIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'CITY_HAS_THEATER_DISTRICT_MACEDON');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ...
    ('BBG_MAGNIFICENT_ARTIST_POINT_HAPPY', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ARTIST'),
    ('BBG_MAGNIFICENT_ARTIST_POINT_ECSTATIC', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ARTIST'),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_HAPPY', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_MUSICIAN'),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_ECSTATIC', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_MUSICIAN'),
    ...
    ('BBG_MAGNIFICENT_ARTIST_POINT_HAPPY', 'HappinessType', 'HAPPINESS_HAPPY'),
    ('BBG_MAGNIFICENT_ARTIST_POINT_ECSTATIC', 'HappinessType', 'HAPPINESS_ECSTATIC'),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_HAPPY', 'HappinessType', 'HAPPINESS_HAPPY'),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_ECSTATIC', 'HappinessType', 'HAPPINESS_ECSTATIC'),
    ('BBG_MAGNIFICENT_WRITER_POINT_HAPPY', 'Amount', 1),
    ('BBG_MAGNIFICENT_WRITER_POINT_ECSTATIC', 'Amount', 2),
    ('BBG_MAGNIFICENT_ARTIST_POINT_HAPPY', 'Amount', 1),
    ('BBG_MAGNIFICENT_ARTIST_POINT_ECSTATIC', 'Amount', 2),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_HAPPY', 'Amount', 1),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_ECSTATIC', 'Amount', 2);
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ...
    ('TRAIT_LEADER_MAGNIFICENCES', 'BBG_MAGNIFICENT_ARTIST_POINT_HAPPY'),
    ('TRAIT_LEADER_MAGNIFICENCES', 'BBG_MAGNIFICENT_ARTIST_POINT_ECSTATIC'),
    ('TRAIT_LEADER_MAGNIFICENCES', 'BBG_MAGNIFICENT_MUSICIAN_POINT_HAPPY'),
    ('TRAIT_LEADER_MAGNIFICENCES', 'BBG_MAGNIFICENT_MUSICIAN_POINT_ECSTATIC');
