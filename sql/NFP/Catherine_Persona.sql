...
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_ON_STRAT_EARLY_EMPIRE_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_ON_STRAT_EARLY_EMPIRE_REQSET', 'REQUIRES_PLOT_HAS_IMPROVED_STRATEGIC'),
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_ON_STRAT_EARLY_EMPIRE_REQSET', 'BBG_PLAYER_HAS_CIVIC_EARLY_EMPIRE_REQUIREMENT');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_MAGNIFICENCE_CULTURE_ON_STRAT', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_TILE_HAS_ANY_IMPROVEMENT_ON_STRAT_EARLY_EMPIRE_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_MAGNIFICENCE_CULTURE_ON_STRAT', 'YieldType', 'YIELD_CULTURE'),
    ('BBG_MAGNIFICENCE_CULTURE_ON_STRAT', 'Amount', 1);

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_ON_LUX_EARLY_EMPIRE_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_ON_LUX_EARLY_EMPIRE_REQSET', 'REQUIRES_PLOT_HAS_IMPROVED_LUXURY'),
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_ON_LUX_EARLY_EMPIRE_REQSET', 'BBG_PLAYER_HAS_CIVIC_EARLY_EMPIRE_REQUIREMENT');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_MAGNIFICENCE_CULTURE_ON_LUX', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_TILE_HAS_ANY_IMPROVEMENT_ON_LUX_EARLY_EMPIRE_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_MAGNIFICENCE_CULTURE_ON_LUX', 'YieldType', 'YIELD_CULTURE'),
    ('BBG_MAGNIFICENCE_CULTURE_ON_LUX', 'Amount', 1);

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_ON_BONUS_EARLY_EMPIRE_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_ON_BONUS_EARLY_EMPIRE_REQSET', 'REQUIRES_PLOT_HAS_IMPROVED_BONUS'),
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_ON_BONUS_EARLY_EMPIRE_REQSET', 'BBG_PLAYER_HAS_CIVIC_EARLY_EMPIRE_REQUIREMENT');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_MAGNIFICENCE_CULTURE_ON_BONUS', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_TILE_HAS_ANY_IMPROVEMENT_ON_BONUS_EARLY_EMPIRE_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
