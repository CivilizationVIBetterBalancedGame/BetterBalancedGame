...
-- 19/01/25 Euphoric (currently HAPPINESS_UNHAPPY) also grant +1 musician point and 15%
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ...
    ('BBG_MAGNIFICENT_CULTURE_EUPHORIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD', NULL),
    ('BBG_MAGNIFICENT_WRITER_POINT_EUPHORIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'BBG_CITY_HAS_DISTRICT_THEATER'),
    ('BBG_MAGNIFICENT_ARTIST_POINT_EUPHORIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'BBG_CITY_HAS_DISTRICT_THEATER'),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_EUPHORIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'BBG_CITY_HAS_DISTRICT_THEATER');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ...
    ('BBG_MAGNIFICENT_CULTURE_EUPHORIC', 'YieldType', 'YIELD_CULTURE'),
    ('BBG_MAGNIFICENT_CULTURE_EUPHORIC', 'HappinessType', 'HAPPINESS_UNHAPPY'),
    ('BBG_MAGNIFICENT_CULTURE_EUPHORIC', 'Amount', 15),
    ('BBG_MAGNIFICENT_WRITER_POINT_EUPHORIC', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_WRITER'),
    ('BBG_MAGNIFICENT_WRITER_POINT_EUPHORIC', 'HappinessType', 'HAPPINESS_UNHAPPY'),
    ('BBG_MAGNIFICENT_WRITER_POINT_EUPHORIC', 'Amount', 1),
    ('BBG_MAGNIFICENT_ARTIST_POINT_EUPHORIC', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ARTIST'),
    ('BBG_MAGNIFICENT_ARTIST_POINT_EUPHORIC', 'HappinessType', 'HAPPINESS_UNHAPPY'),
    ('BBG_MAGNIFICENT_ARTIST_POINT_EUPHORIC', 'Amount', 1),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_EUPHORIC', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_MUSICIAN'),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_EUPHORIC', 'HappinessType', 'HAPPINESS_UNHAPPY'),
    ('BBG_MAGNIFICENT_MUSICIAN_POINT_EUPHORIC', 'Amount', 1);
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ...
    ('TRAIT_LEADER_MAGNIFICENCES', 'BBG_MAGNIFICENT_CULTURE_EUPHORIC'),
    ('TRAIT_LEADER_MAGNIFICENCES', 'BBG_MAGNIFICENT_WRITER_POINT_EUPHORIC'),
    ('TRAIT_LEADER_MAGNIFICENCES', 'BBG_MAGNIFICENT_ARTIST_POINT_EUPHORIC'),
    ('TRAIT_LEADER_MAGNIFICENCES', 'BBG_MAGNIFICENT_MUSICIAN_POINT_EUPHORIC');
