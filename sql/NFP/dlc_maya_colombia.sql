...
INSERT INTO StartBiasResources(CivilizationType, ResourceType, Tier) VALUES
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_CITRUS', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_COFFEE', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_COCOA', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_COTTON', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_DYES', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_SILK', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_SPICES', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_SUGAR', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_TEA', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_TOBACCO', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_WINE', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_INCENSE', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_OLIVES', 5),
    ('CIVILIZATION_COLOMBIA', 'RESOURCE_BANANAS', 5);
