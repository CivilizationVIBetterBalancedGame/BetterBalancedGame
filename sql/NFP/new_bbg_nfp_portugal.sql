...
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_TILE_IS_IMPROVED_GRASS_FLOODPLAIN', 'REQUIREMENTSET_TEST_ALL'),
    ('BBG_TILE_IS_IMPROVED_PLAINS_FLOODPLAIN', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_TILE_IS_IMPROVED_GRASS_FLOODPLAIN', 'REQUIRES_PLOT_HAS_GRASS_FLOODPLAINS'),
    ('BBG_TILE_IS_IMPROVED_GRASS_FLOODPLAIN', 'BBG_TILE_HAS_ANY_IMPROVEMENT'),
    ('BBG_TILE_IS_IMPROVED_PLAINS_FLOODPLAIN', 'REQUIRES_PLOT_HAS_PLAINS_FLOODPLAINS'),
    ('BBG_TILE_IS_IMPROVED_PLAINS_FLOODPLAIN', 'BBG_TILE_HAS_ANY_IMPROVEMENT');
UPDATE Modifiers SET SubjectRequirementSetId='BBG_TILE_IS_IMPROVED_GRASS_FLOODPLAIN' WHERE ModifierId='ETEMENANKI_SCIENCE_GRASS_FLOODPLAINS';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_TILE_IS_IMPROVED_PLAINS_FLOODPLAIN' WHERE ModifierId='ETEMENANKI_SCIENCE_PLAINS_FLOODPLAINS';