...
-- 14/07/26 Vietnam gets +1 gold for buildings in the floodplains
-- not added : it affects city center buildings as floodplains are not removed when settled + not possible to test the district type

-- INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
--     ('TRAIT_FLOODPLAINS_DESERT_BUILDINGS_GOLD', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_FEATURE_YIELD_CHANGE'),
--     ('TRAIT_FLOODPLAINS_PLAINS_BUILDINGS_GOLD', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_FEATURE_YIELD_CHANGE'),
--     ('TRAIT_FLOODPLAINS_GRASSLAND_BUILDINGS_GOLD', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_FEATURE_YIELD_CHANGE');

-- INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
--     ('TRAIT_FLOODPLAINS_DESERT_BUILDINGS_GOLD', 'FeatureType', 'FEATURE_FLOODPLAINS'),
--     ('TRAIT_FLOODPLAINS_DESERT_BUILDINGS_GOLD', 'YieldType', 'YIELD_GOLD'),
--     ('TRAIT_FLOODPLAINS_DESERT_BUILDINGS_GOLD', 'Amount', '1'),
--     ('TRAIT_FLOODPLAINS_PLAINS_BUILDINGS_GOLD', 'FeatureType', 'FEATURE_FLOODPLAINS_PLAINS'),
--     ('TRAIT_FLOODPLAINS_PLAINS_BUILDINGS_GOLD', 'YieldType', 'YIELD_GOLD'),
--     ('TRAIT_FLOODPLAINS_PLAINS_BUILDINGS_GOLD', 'Amount', '1'),
--     ('TRAIT_FLOODPLAINS_GRASSLAND_BUILDINGS_GOLD', 'FeatureType', 'FEATURE_FLOODPLAINS_GRASSLAND'),
--     ('TRAIT_FLOODPLAINS_GRASSLAND_BUILDINGS_GOLD', 'YieldType', 'YIELD_GOLD'),
--     ('TRAIT_FLOODPLAINS_GRASSLAND_BUILDINGS_GOLD', 'Amount', '1');

-- INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
--     ('TRAIT_CIVILIZATION_VIETNAM', 'TRAIT_FLOODPLAINS_DESERT_BUILDINGS_GOLD'),
--     ('TRAIT_CIVILIZATION_VIETNAM', 'TRAIT_FLOODPLAINS_PLAINS_BUILDINGS_GOLD'),
--     ('TRAIT_CIVILIZATION_VIETNAM', 'TRAIT_FLOODPLAINS_GRASSLAND_BUILDINGS_GOLD');
