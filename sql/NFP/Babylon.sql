...
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_AND_IS_FRESH_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_AND_IS_FRESH_REQSET', 'BBG_TILE_HAS_ANY_IMPROVEMENT'),
    ('BBG_TILE_HAS_ANY_IMPROVEMENT_AND_IS_FRESH_REQSET', 'REQUIRES_PLOT_IS_FRESH_WATER');
UPDATE Modifiers SET SubjectRequirementSetId='BBG_TILE_HAS_ANY_IMPROVEMENT_AND_IS_FRESH_REQSET' WHERE ModifierId='PALGUM_ADDFOOD';
