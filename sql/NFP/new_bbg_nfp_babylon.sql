...
INSERT INTO RequirementSets(RequirementSetId , RequirementSetType)
    SELECT 'BBG_PLAYER_IS_HAMMURABI_IN_' || EraType, 'REQUIREMENTSET_TEST_ALL' FROM Eras;
INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_ANCIENT', 'BBG_PLAYER_IS_IN_ERA_ANCIENT_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_ANCIENT', 'BBG_PLAYER_IS_NOT_IN_ERA_CLASSICAL_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_CLASSICAL', 'BBG_PLAYER_IS_IN_ERA_CLASSICAL_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_CLASSICAL', 'BBG_PLAYER_IS_NOT_IN_ERA_MEDIEVAL_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_MEDIEVAL', 'BBG_PLAYER_IS_IN_ERA_MEDIEVAL_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_MEDIEVAL', 'BBG_PLAYER_IS_NOT_IN_ERA_RENAISSANCE_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_RENAISSANCE', 'BBG_PLAYER_IS_IN_ERA_RENAISSANCE_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_RENAISSANCE', 'BBG_PLAYER_IS_NOT_IN_ERA_INDUSTRIAL_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_INDUSTRIAL', 'BBG_PLAYER_IS_IN_ERA_INDUSTRIAL_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_INDUSTRIAL', 'BBG_PLAYER_IS_NOT_IN_ERA_MODERN_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_MODERN', 'BBG_PLAYER_IS_IN_ERA_MODERN_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_MODERN', 'BBG_PLAYER_IS_NOT_IN_ERA_ATOMIC_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_ATOMIC', 'BBG_PLAYER_IS_IN_ERA_ATOMIC_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_ATOMIC', 'BBG_PLAYER_IS_NOT_IN_ERA_INFORMATION_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_INFORMATION', 'BBG_PLAYER_IS_IN_ERA_INFORMATION_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_INFORMATION', 'BBG_PLAYER_IS_NOT_IN_ERA_FUTURE_REQUIREMENT'),
  ('BBG_PLAYER_IS_HAMMURABI_IN_ERA_FUTURE', 'BBG_PLAYER_IS_IN_ERA_FUTURE_REQUIREMENT');
INSERT INTO RequirementSetRequirements(RequirementSetId , RequirementId)
    SELECT  'BBG_PLAYER_IS_HAMMURABI_IN_' || EraType, 'BBG_PLAYER_IS_HAMMURABI_REQUIREMENT' FROM Eras;

INSERT INTO Requirements(RequirementId, RequirementType) VALUES
    ('BBG_PLAYER_IS_HAMMURABI_REQUIREMENT', 'REQUIREMENT_PLAYER_TYPE_MATCHES');
INSERT INTO RequirementArguments(RequirementId, Name, Value) VALUES
    ('BBG_PLAYER_IS_HAMMURABI_REQUIREMENT', 'LeaderType', 'LEADER_HAMMURABI');

INSERT INTO Modifiers(ModifierId, ModifierType, OwnerRequirementSetId) 
    SELECT 'BBG_HAMMURABI_FREE_EUREKA_LIBRARY_' || EraType, 'MODIFIER_PLAYER_GRANT_RANDOM_TECHNOLOGY_BOOST_BY_ERA', 'BBG_PLAYER_IS_HAMMURABI_IN_' || EraType FROM Eras;
INSERT INTO ModifierArguments(ModifierId, Name, Value)
    SELECT 'BBG_HAMMURABI_FREE_EUREKA_LIBRARY_' || EraType, 'StartEraType', 'ERA_ANCIENT' FROM Eras;
INSERT INTO ModifierArguments(ModifierId, Name, Value)
    SELECT 'BBG_HAMMURABI_FREE_EUREKA_LIBRARY_' || EraType, 'EndEraType', EraType FROM Eras;
INSERT INTO ModifierArguments(ModifierId, Name, Value)
    SELECT 'BBG_HAMMURABI_FREE_EUREKA_LIBRARY_' || EraType, 'Amount', 1 FROM Eras;
INSERT INTO BuildingModifiers(BuildingType, ModifierId)
    SELECT 'BUILDING_LIBRARY', 'BBG_HAMMURABI_FREE_EUREKA_LIBRARY_' || EraType FROM Eras;
