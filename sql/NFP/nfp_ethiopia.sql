...
INSERT OR IGNORE INTO Modifiers (ModifierId , ModifierType, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
    ('TRAIT_FAITH_CAMP_FISH_PASTURE_PLANTATION_QUARRY_RESOURCES', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_UTILS_PLAYER_HAS_CIVIC_POLITICAL_PHILOSOPHY_REQSET', 'PLOT_HAS_CAMP_FISH_PASTURE_PLANTATION_QUARRY_REQUIREMENTS'),
    ('TRAIT_FAITH_FARMED_RESOURCES', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_UTILS_PLAYER_HAS_CIVIC_POLITICAL_PHILOSOPHY_REQSET', 'PLOT_HAS_RESOURCE_FARM_REQUIREMENTS'),
    ('TRAIT_FAITH_MINED_BONUS_RESOURCES', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_UTILS_PLAYER_HAS_CIVIC_POLITICAL_PHILOSOPHY_REQSET', 'PLOT_HAS_BONUS_MINE_REQUIREMENTS'),
    ('TRAIT_FAITH_MINED_LUXURY_RESOURCES', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_UTILS_PLAYER_HAS_CIVIC_POLITICAL_PHILOSOPHY_REQSET', 'PLOT_HAS_LUXURY_MINE_REQUIREMENTS'),
    ('TRAIT_FAITH_MINED_STRATEGIC_RESOURCES', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_UTILS_PLAYER_HAS_CIVIC_POLITICAL_PHILOSOPHY_REQSET', 'PLOT_HAS_STRATEGIC_MINE_REQUIREMENTS'); 
