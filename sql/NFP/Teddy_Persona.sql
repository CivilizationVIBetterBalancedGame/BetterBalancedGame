...
-- 19/03/2024 culture/science on breathtaking tiles requires code of law
INSERT OR IGNORE INTO RequirementSetRequirements VALUES
  ('REQUIREMENTS_PLOT_ADJACENT_FORESTS_OR_WONDERS_BREATHTAKING', 'REQUIRES_PLAYER_CODE_OF_LAWS_BBG'),
  ('REQUIREMENTS_PLOT_ADJACENT_NATURAL_WONDERS_OR_MOUNTAINS_BREATHTAKING', 'REQUIRES_PLAYER_CODE_OF_LAWS_BBG');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
  ('REQUIRES_PLAYER_CODE_OF_LAWS_BBG', 'REQUIREMENT_PLAYER_HAS_CIVIC');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
  ('REQUIRES_PLAYER_CODE_OF_LAWS_BBG', 'CivicType', 'CIVIC_CODE_OF_LAWS');
