...
-- 18/01/26 Euphoric gives another +5 (it's +8 amenity and is using the unhappy tag for now but everything is in control)
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
	('BBG_SCIENCE_EUPHORIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD', NULL),
	('BBG_PRODUCTION_EUPHORIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD', NULL),
	('BBG_SCIENTIST_EUPHORIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'BBG_CITY_HAS_DISTRICT_CAMPUS'),
	('BBG_ENGINEER_EUPHORIC', 'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON', 'BBG_CITY_HAS_DISTRICT_INDUSTRIAL_ZONE');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
	('BBG_SCIENCE_EUPHORIC', 'YieldType', 'YIELD_SCIENCE'),
	('BBG_SCIENCE_EUPHORIC', 'HappinessType', 'HAPPINESS_UNHAPPY'),
	('BBG_SCIENCE_EUPHORIC', 'Amount', 15),
	('BBG_PRODUCTION_EUPHORIC', 'YieldType', 'YIELD_PRODUCTION'),
	('BBG_PRODUCTION_EUPHORIC', 'HappinessType', 'HAPPINESS_UNHAPPY'),
	('BBG_PRODUCTION_EUPHORIC', 'Amount', 15),
	('BBG_SCIENTIST_EUPHORIC', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_SCIENTIST'),
	('BBG_SCIENTIST_EUPHORIC', 'HappinessType', 'HAPPINESS_UNHAPPY'),
	('BBG_SCIENTIST_EUPHORIC', 'Amount', 3),
	('BBG_ENGINEER_EUPHORIC', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ENGINEER'),
	('BBG_ENGINEER_EUPHORIC', 'HappinessType', 'HAPPINESS_UNHAPPY'),
	('BBG_ENGINEER_EUPHORIC', 'Amount', 3);
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
	('TRAIT_CIVILIZATION_SCOTTISH_ENLIGHTENMENT', 'BBG_SCIENCE_EUPHORIC'),
	('TRAIT_CIVILIZATION_SCOTTISH_ENLIGHTENMENT', 'BBG_PRODUCTION_EUPHORIC'),
	('TRAIT_CIVILIZATION_SCOTTISH_ENLIGHTENMENT', 'BBG_SCIENTIST_EUPHORIC'),
	('TRAIT_CIVILIZATION_SCOTTISH_ENLIGHTENMENT', 'BBG_ENGINEER_EUPHORIC');
