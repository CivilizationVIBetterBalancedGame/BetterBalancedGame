...
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
    ('BBG_EDUCATOR_BOOST_LIBRARY', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'),
    ('BBG_EDUCATOR_BOOST_UNIVERSITY', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'),
    ('BBG_EDUCATOR_BOOST_MADRASA', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'),
    ('BBG_EDUCATOR_BOOST_LAB', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_EDUCATOR_BOOST_LIBRARY', 'BuildingType', 'BUILDING_LIBRARY'),
    ('BBG_EDUCATOR_BOOST_UNIVERSITY', 'BuildingType', 'BUILDING_UNIVERSITY'),
    ('BBG_EDUCATOR_BOOST_MADRASA', 'BuildingType', 'BUILDING_MADRASA'),
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES
    ...
    ('BBG_GOVERNOR_PROMOTION_EDUCATOR_CAMPUS_BUILDING_YIELDS', 'BBG_EDUCATOR_BOOST_MADRASA'),
