...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_PRAETORIUM_PRODUCTION_TO_GOV_CONQUERED_CITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_PRAETORIUM_PRODUCTION_TO_GOV_CONQUERED_CITIES', 'YieldType', 'YIELD_PRODUCTION'),
    ('BBG_PRAETORIUM_PRODUCTION_TO_GOV_CONQUERED_CITIES', 'Amount', 20);
INSERT INTO PolicyModifiers (PolicyType, ModifierId) VALUES
    ('POLICY_PRAETORIUM', 'BBG_PRAETORIUM_PRODUCTION_TO_GOV_CONQUERED_CITIES');