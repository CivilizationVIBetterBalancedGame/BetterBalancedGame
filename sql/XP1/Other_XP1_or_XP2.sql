...
INSERT INTO Requirements(RequirementId, RequirementType) VALUES
	('EXPDUS_ACTIVE_REQ', 'REQUIREMENT_COLLECTION_COUNT_ATLEAST');
INSERT INTO RequirementArguments(RequirementId, Name, Value) VALUES
	('EXPDUS_ACTIVE_REQ', 'CollectionType', 'COLLECTION_PLAYER_CITIES'),
	('EXPDUS_ACTIVE_REQ', 'Count', '1'),
	('EXPDUS_ACTIVE_REQ','RequirementSetId', 'EXODUS_PLOTPROPERTY_REQSET');
INSERT INTO RequirementSets(RequirementSetId, RequirementSetType) VALUES
	('PLAYER_HAS_GOLDEN_EXODUS_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
	('PLAYER_HAS_GOLDEN_EXODUS_REQSET', 'EXPDUS_ACTIVE_REQ'),
