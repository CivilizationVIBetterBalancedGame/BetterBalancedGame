...
-- Plotproperty control allows to remove it after golden
/*
INSERT INTO Requirements(RequirementId, RequirementType) VALUES
	('EXODUS_PLOTPROPERTY_REQ','REQUIREMENT_PLOT_PROPERTY_MATCHES');
INSERT INTO RequirementArguments(RequirementId, Name, Value) VALUES
	('EXODUS_PLOTPROPERTY_REQ', 'PropertyName', 'EXODUS_ON'),
	('EXODUS_PLOTPROPERTY_REQ', 'PropertyMinimum', '1');
INSERT INTO RequirementSets(RequirementSetId, RequirementSetType) VALUES
	('EXODUS_PLOTPROPERTY_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
	('EXODUS_PLOTPROPERTY_REQSET', 'EXODUS_PLOTPROPERTY_REQ');
INSERT INTO Requirements(RequirementId, RequirementType) VALUES
	('EXODUS_ACTIVE_REQ', 'REQUIREMENT_COLLECTION_COUNT_ATLEAST');
INSERT INTO RequirementArguments(RequirementId, Name, Value) VALUES
	('EXODUS_ACTIVE_REQ', 'CollectionType', 'COLLECTION_PLAYER_CITIES'),
	('EXODUS_ACTIVE_REQ', 'Count', '1'),
	('EXODUS_ACTIVE_REQ','RequirementSetId', 'EXODUS_PLOTPROPERTY_REQSET');
INSERT INTO RequirementSets(RequirementSetId, RequirementSetType) VALUES
	('PLAYER_HAS_GOLDEN_EXODUS_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
	('PLAYER_HAS_GOLDEN_EXODUS_REQSET', 'EXODUS_ACTIVE_REQ'),
	('PLAYER_HAS_GOLDEN_EXODUS_REQSET', 'REQUIRES_PLAYER_HAS_GOLDEN_AGE');

INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId) VALUES
	('BBG_EXODUS_GOLD_PER_FOREIGN_CITY_FOLLOWING_RELIGION', 'MODIFIER_PLAYER_RELIGION_ADD_PLAYER_BELIEF_YIELD', 'PLAYER_HAS_GOLDEN_EXODUS_REQSET'),
	('BBG_EXODUS_CULTURE_PER_FOREIGN_CITY_FOLLOWING_RELIGION', 'MODIFIER_PLAYER_RELIGION_ADD_PLAYER_BELIEF_YIELD', 'PLAYER_HAS_GOLDEN_EXODUS_REQSET'),
	('BBG_EXODUS_SCIENCE_PER_FOREIGN_CITY_FOLLOWING_RELIGION', 'MODIFIER_PLAYER_RELIGION_ADD_PLAYER_BELIEF_YIELD', 'PLAYER_HAS_GOLDEN_EXODUS_REQSET');
