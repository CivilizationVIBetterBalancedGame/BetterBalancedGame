...
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
    ('BBG_SEONDEOK_MINUS_AFTER_FEUDALISM_NO_GOV', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER_GRANCOLOMBIA_MAYA', 'BBG_UTILS_PLAYER_HAS_CIVIC_FEUDALISM_REQSET', 'CITY_HAS_NO_GOVERNOR_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_SEONDEOK_MINUS_AFTER_FEUDALISM_NO_GOV', 'YieldType', 'YIELD_PRODUCTION, YIELD_FOOD, YIELD_SCIENCE, YIELD_CULTURE, YIELD_GOLD, YIELD_FAITH'),
