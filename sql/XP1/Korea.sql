...
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_CITY_HAS_SEOWON_AND_NO_GOV_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_CITY_HAS_SEOWON_AND_NO_GOV_REQSET', 'REQUIRES_NOT_CITY_HAS_GOV'),
    ('BBG_CITY_HAS_SEOWON_AND_NO_GOV_REQSET', 'BBG_CITY_HAS_DISTRICT_SEOWON_REQUIREMENT');
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
    ('BBG_SEONDEOK_MINUS_AFTER_FEUDALISM_SEOWON_NO_GOV', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER_GRANCOLOMBIA_MAYA', 'BBG_UTILS_PLAYER_HAS_CIVIC_FEUDALISM_REQSET', 'BBG_CITY_HAS_SEOWON_AND_NO_GOV_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
