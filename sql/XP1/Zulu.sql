...
-- 16/03/26 increase %prod in ikanda as game progress (5% base, 5% mercenaries, 5% nationalism, 5% mobilization, 5% ideology)
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_MERCENARIES', 'MODIFIER_CITY_CORPS_ARMY_ADJUST_DISCOUNT', 'BBG_UTILS_PLAYER_HAS_CIVIC_MERCENARIES_REQSET'),
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_NATIONALISM', 'MODIFIER_CITY_CORPS_ARMY_ADJUST_DISCOUNT', 'BBG_UTILS_PLAYER_HAS_CIVIC_NATIONALISM_REQSET'),
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_MOBILIZATION', 'MODIFIER_CITY_CORPS_ARMY_ADJUST_DISCOUNT', 'BBG_UTILS_PLAYER_HAS_CIVIC_MOBILIZATION_REQSET'),
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_IDEOLOGY', 'MODIFIER_CITY_CORPS_ARMY_ADJUST_DISCOUNT', 'BBG_UTILS_PLAYER_HAS_CIVIC_IDEOLOGY_REQSET');

INSERT OR IGNORE INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_MERCENARIES', 'Amount', '5'),
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_MERCENARIES', 'UnitDomain', 'DOMAIN_LAND'),
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_NATIONALISM', 'Amount', '5'),
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_NATIONALISM', 'UnitDomain', 'DOMAIN_LAND'),
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_MOBILIZATION', 'Amount', '5'),
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_MOBILIZATION', 'UnitDomain', 'DOMAIN_LAND'),
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_IDEOLOGY', 'Amount', '5'),
    ('BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_IDEOLOGY', 'UnitDomain', 'DOMAIN_LAND');

INSERT OR IGNORE INTO DistrictModifiers (DistrictType, ModifierId) VALUES
    ('DISTRICT_IKANDA', 'BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_MERCENARIES'),
    ('DISTRICT_IKANDA', 'BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_NATIONALISM'),
    ('DISTRICT_IKANDA', 'BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_MOBILIZATION'),
    ('DISTRICT_IKANDA', 'BBG_IKANDA_TRAINED_CORPS_ARMY_DISCOUNT_IDEOLOGY');