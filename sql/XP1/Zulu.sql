...
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_HAS_CIVIC_MOBILIZATION_REQSET' WHERE ModifierId='TRAIT_LAND_CORPS_COMBAT_STRENGTH';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_HAS_CIVIC_MOBILIZATION_REQSET' WHERE ModifierId='TRAIT_LAND_ARMIES_COMBAT_STRENGTH';
