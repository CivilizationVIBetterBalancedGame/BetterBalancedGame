...
-- 24/08/26 Bonus production for Nubian ranged units for naval ranged too
INSERT INTO Modifiers(ModifierId, ModifierType) VALUES
    ('BBG_TRAIT_ANCIENT_RANGED_UNIT_PRODUCTION_NAVAL', 'MODIFIER_PLAYER_CITIES_ADJUST_UNIT_TAG_ERA_PRODUCTION'),
    ('BBG_TRAIT_CLASSICAL_RANGED_UNIT_PRODUCTION_NAVAL', 'MODIFIER_PLAYER_CITIES_ADJUST_UNIT_TAG_ERA_PRODUCTION'),
    ('BBG_TRAIT_MEDIEVAL_RANGED_UNIT_PRODUCTION_NAVAL', 'MODIFIER_PLAYER_CITIES_ADJUST_UNIT_TAG_ERA_PRODUCTION'),
    ('BBG_TRAIT_RENAISSANCE_RANGED_UNIT_PRODUCTION_NAVAL', 'MODIFIER_PLAYER_CITIES_ADJUST_UNIT_TAG_ERA_PRODUCTION'),
    ('BBG_TRAIT_INDUSTRIAL_RANGED_UNIT_PRODUCTION_NAVAL', 'MODIFIER_PLAYER_CITIES_ADJUST_UNIT_TAG_ERA_PRODUCTION'),
    ('BBG_TRAIT_MODERN_RANGED_UNIT_PRODUCTION_NAVAL', 'MODIFIER_PLAYER_CITIES_ADJUST_UNIT_TAG_ERA_PRODUCTION'),
    ('BBG_TRAIT_ATOMIC_RANGED_UNIT_PRODUCTION_NAVAL', 'MODIFIER_PLAYER_CITIES_ADJUST_UNIT_TAG_ERA_PRODUCTION'),
    ('BBG_TRAIT_INFORMATION_RANGED_UNIT_PRODUCTION_NAVAL', 'MODIFIER_PLAYER_CITIES_ADJUST_UNIT_TAG_ERA_PRODUCTION');

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_TRAIT_ANCIENT_RANGED_UNIT_PRODUCTION_NAVAL', 'Amount', 30),
    ('BBG_TRAIT_CLASSICAL_RANGED_UNIT_PRODUCTION_NAVAL', 'Amount', 30),
    ('BBG_TRAIT_MEDIEVAL_RANGED_UNIT_PRODUCTION_NAVAL', 'Amount', 30),
    ('BBG_TRAIT_RENAISSANCE_RANGED_UNIT_PRODUCTION_NAVAL', 'Amount', 30),
    ('BBG_TRAIT_INDUSTRIAL_RANGED_UNIT_PRODUCTION_NAVAL', 'Amount', 30),
    ('BBG_TRAIT_MODERN_RANGED_UNIT_PRODUCTION_NAVAL', 'Amount', 30),
    ('BBG_TRAIT_ATOMIC_RANGED_UNIT_PRODUCTION_NAVAL', 'Amount', 30),
    ('BBG_TRAIT_INFORMATION_RANGED_UNIT_PRODUCTION_NAVAL', 'Amount', 30);

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_TRAIT_ANCIENT_RANGED_UNIT_PRODUCTION_NAVAL', 'EraType', 'ERA_ANCIENT'),
    ('BBG_TRAIT_CLASSICAL_RANGED_UNIT_PRODUCTION_NAVAL', 'EraType', 'ERA_CLASSICAL'),
    ('BBG_TRAIT_MEDIEVAL_RANGED_UNIT_PRODUCTION_NAVAL', 'EraType', 'ERA_MEDIEVAL'),
    ('BBG_TRAIT_RENAISSANCE_RANGED_UNIT_PRODUCTION_NAVAL', 'EraType', 'ERA_RENAISSANCE'),
    ('BBG_TRAIT_INDUSTRIAL_RANGED_UNIT_PRODUCTION_NAVAL', 'EraType', 'ERA_INDUSTRIAL'),
    ('BBG_TRAIT_MODERN_RANGED_UNIT_PRODUCTION_NAVAL', 'EraType', 'ERA_MODERN'),
    ('BBG_TRAIT_ATOMIC_RANGED_UNIT_PRODUCTION_NAVAL', 'EraType', 'ERA_ATOMIC'),
    ('BBG_TRAIT_INFORMATION_RANGED_UNIT_PRODUCTION_NAVAL', 'EraType', 'ERA_INFORMATION');

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_TRAIT_ANCIENT_RANGED_UNIT_PRODUCTION_NAVAL', 'UnitPromotionClass', 'PROMOTION_CLASS_NAVAL_RANGED'),
    ('BBG_TRAIT_CLASSICAL_RANGED_UNIT_PRODUCTION_NAVAL', 'UnitPromotionClass', 'PROMOTION_CLASS_NAVAL_RANGED'),
    ('BBG_TRAIT_MEDIEVAL_RANGED_UNIT_PRODUCTION_NAVAL', 'UnitPromotionClass', 'PROMOTION_CLASS_NAVAL_RANGED'),
    ('BBG_TRAIT_RENAISSANCE_RANGED_UNIT_PRODUCTION_NAVAL', 'UnitPromotionClass', 'PROMOTION_CLASS_NAVAL_RANGED'),
    ('BBG_TRAIT_INDUSTRIAL_RANGED_UNIT_PRODUCTION_NAVAL', 'UnitPromotionClass', 'PROMOTION_CLASS_NAVAL_RANGED'),
    ('BBG_TRAIT_MODERN_RANGED_UNIT_PRODUCTION_NAVAL', 'UnitPromotionClass', 'PROMOTION_CLASS_NAVAL_RANGED'),
    ('BBG_TRAIT_ATOMIC_RANGED_UNIT_PRODUCTION_NAVAL', 'UnitPromotionClass', 'PROMOTION_CLASS_NAVAL_RANGED'),
    ('BBG_TRAIT_INFORMATION_RANGED_UNIT_PRODUCTION_NAVAL', 'UnitPromotionClass', 'PROMOTION_CLASS_NAVAL_RANGED');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ('TRAIT_CIVILIZATION_TA_SETI', 'BBG_TRAIT_ANCIENT_RANGED_UNIT_PRODUCTION_NAVAL'),
    ('TRAIT_CIVILIZATION_TA_SETI', 'BBG_TRAIT_CLASSICAL_RANGED_UNIT_PRODUCTION_NAVAL'),
    ('TRAIT_CIVILIZATION_TA_SETI', 'BBG_TRAIT_MEDIEVAL_RANGED_UNIT_PRODUCTION_NAVAL'),
    ('TRAIT_CIVILIZATION_TA_SETI', 'BBG_TRAIT_RENAISSANCE_RANGED_UNIT_PRODUCTION_NAVAL'),
    ('TRAIT_CIVILIZATION_TA_SETI', 'BBG_TRAIT_INDUSTRIAL_RANGED_UNIT_PRODUCTION_NAVAL'),
    ('TRAIT_CIVILIZATION_TA_SETI', 'BBG_TRAIT_MODERN_RANGED_UNIT_PRODUCTION_NAVAL'),
    ('TRAIT_CIVILIZATION_TA_SETI', 'BBG_TRAIT_ATOMIC_RANGED_UNIT_PRODUCTION_NAVAL'),
    ('TRAIT_CIVILIZATION_TA_SETI', 'BBG_TRAIT_INFORMATION_RANGED_UNIT_PRODUCTION_NAVAL');
