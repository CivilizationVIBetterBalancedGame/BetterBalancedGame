...
-- 02/01/26 Delayed to T1 building but gets +1 with T3 building
...
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_CITY_HAS_STABLE_BARRACKS_REQSET', 'REQUIREMENTSET_TEST_ANY');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_CITY_HAS_STABLE_BARRACKS_REQSET', 'REQUIRES_CITY_HAS_BARRACKS'),
    ('BBG_CITY_HAS_STABLE_BARRACKS_REQSET', 'REQUIRES_CITY_HAS_STABLE');

INSERT INTO Modifiers(ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_WAR_AND_PLUNDER_MARKET', 'MODIFIER_ALL_CITIES_ATTACH_MODIFIER', 'CITY_FOLLOWS_PANTHEON_REQUIREMENTS'),
    ('BBG_WAR_AND_PLUNDER_LIGHTHOUSE', 'MODIFIER_ALL_CITIES_ATTACH_MODIFIER', 'CITY_FOLLOWS_PANTHEON_REQUIREMENTS'),
    ('BBG_WAR_AND_PLUNDER_BARRACKS_STABLE', 'MODIFIER_ALL_CITIES_ATTACH_MODIFIER', 'CITY_FOLLOWS_PANTHEON_REQUIREMENTS'),
    ('BBG_WAR_AND_PLUNDER_MARKET_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BUILDING_IS_MARKET'),
    ('BBG_WAR_AND_PLUNDER_LIGHTHOUSE_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BUILDING_IS_LIGHTHOUSE'),
    ('BBG_WAR_AND_PLUNDER_BARRACKS_STABLE_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BBG_CITY_HAS_STABLE_BARRACKS_REQSET');
INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
    ('BBG_WAR_AND_PLUNDER_MARKET', 'ModifierId', 'BBG_WAR_AND_PLUNDER_MARKET_MODIFIER'),
    ('BBG_WAR_AND_PLUNDER_MARKET_MODIFIER', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_MERCHANT'),
    ('BBG_WAR_AND_PLUNDER_MARKET_MODIFIER', 'Amount', 1),
    ('BBG_WAR_AND_PLUNDER_LIGHTHOUSE', 'ModifierId', 'BBG_WAR_AND_PLUNDER_LIGHTHOUSE_MODIFIER'),
    ('BBG_WAR_AND_PLUNDER_LIGHTHOUSE_MODIFIER', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ADMIRAL'),
    ('BBG_WAR_AND_PLUNDER_LIGHTHOUSE_MODIFIER', 'Amount', 1),
    ('BBG_WAR_AND_PLUNDER_BARRACKS_STABLE', 'ModifierId', 'BBG_WAR_AND_PLUNDER_BARRACKS_STABLE_MODIFIER'),
    ('BBG_WAR_AND_PLUNDER_BARRACKS_STABLE_MODIFIER', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_GENERAL'),
    ('BBG_WAR_AND_PLUNDER_BARRACKS_STABLE_MODIFIER', 'Amount', 1);
INSERT INTO BeliefModifiers(BeliefType, ModifierID) VALUES
    ('BELIEF_GOD_OF_WAR', 'BBG_WAR_AND_PLUNDER_MARKET'),
    ('BELIEF_GOD_OF_WAR', 'BBG_WAR_AND_PLUNDER_LIGHTHOUSE'),
    ('BELIEF_GOD_OF_WAR', 'BBG_WAR_AND_PLUNDER_BARRACKS_STABLE');

-- T3 buildings
INSERT INTO Modifiers(ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_WAR_AND_PLUNDER_STOCK_EXCHANGE', 'MODIFIER_ALL_CITIES_ATTACH_MODIFIER', 'CITY_FOLLOWS_PANTHEON_REQUIREMENTS'),
    ('BBG_WAR_AND_PLUNDER_SEAPORT', 'MODIFIER_ALL_CITIES_ATTACH_MODIFIER', 'CITY_FOLLOWS_PANTHEON_REQUIREMENTS'),
    ('BBG_WAR_AND_PLUNDER_MILITARY_ACADEMY', 'MODIFIER_ALL_CITIES_ATTACH_MODIFIER', 'CITY_FOLLOWS_PANTHEON_REQUIREMENTS'),
    ('BBG_WAR_AND_PLUNDER_STOCK_EXCHANGE_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BUILDING_IS_STOCK_EXCHANGE'),
    ('BBG_WAR_AND_PLUNDER_SEAPORT_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BUILDING_IS_SEAPORT'),
    ('BBG_WAR_AND_PLUNDER_MILITARY_ACADEMY_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'BBG_CITY_HAS_STABLE_BARRACKS_REQSET');
INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
    ('BBG_WAR_AND_PLUNDER_STOCK_EXCHANGE', 'ModifierId', 'BBG_WAR_AND_PLUNDER_STOCK_EXCHANGE_MODIFIER'),
    ('BBG_WAR_AND_PLUNDER_STOCK_EXCHANGE_MODIFIER', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_MERCHANT'),
    ('BBG_WAR_AND_PLUNDER_STOCK_EXCHANGE_MODIFIER', 'Amount', 1),
    ('BBG_WAR_AND_PLUNDER_SEAPORT', 'ModifierId', 'BBG_WAR_AND_PLUNDER_SEAPORT_MODIFIER'),
    ('BBG_WAR_AND_PLUNDER_SEAPORT_MODIFIER', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ADMIRAL'),
    ('BBG_WAR_AND_PLUNDER_SEAPORT_MODIFIER', 'Amount', 1),
    ('BBG_WAR_AND_PLUNDER_MILITARY_ACADEMY', 'ModifierId', 'BBG_WAR_AND_PLUNDER_MILITARY_ACADEMY_MODIFIER'),
    ('BBG_WAR_AND_PLUNDER_MILITARY_ACADEMY_MODIFIER', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_GENERAL'),
    ('BBG_WAR_AND_PLUNDER_MILITARY_ACADEMY_MODIFIER', 'Amount', 1);
INSERT INTO BeliefModifiers(BeliefType, ModifierID) VALUES
    ('BELIEF_GOD_OF_WAR', 'BBG_WAR_AND_PLUNDER_STOCK_EXCHANGE'),
    ('BELIEF_GOD_OF_WAR', 'BBG_WAR_AND_PLUNDER_SEAPORT'),
    ('BELIEF_GOD_OF_WAR', 'BBG_WAR_AND_PLUNDER_MILITARY_ACADEMY');
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ...
    ('BBG_FIRE_GODDESS_NEXT_VOLCANO_MODIFIER', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 'BBG_TILE_ADJACENT_TO_VOLCANO_REQSET');
INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
    ('BBG_FIRE_GODDESS_NEXT_VOLCANO_GIVER', 'ModifierId', 'BBG_FIRE_GODDESS_NEXT_VOLCANO_MODIFIER'),
    ('BBG_FIRE_GODDESS_NEXT_VOLCANO_MODIFIER', 'YieldType', 'YIELD_FAITH'),
    ('BBG_FIRE_GODDESS_NEXT_VOLCANO_MODIFIER', 'Amount', 2);
INSERT INTO BeliefModifiers(BeliefType, ModifierID) VALUES
...
INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
    ('BBG_FIRE_GODDESS_GEOTHERMAL_GIVER', 'ModifierId', 'BBG_FIRE_GODDESS_GEOTHERMAL_MODIFIER'),
    ('BBG_FIRE_GODDESS_GEOTHERMAL_MODIFIER', 'YieldType', 'YIELD_FAITH'),
    ('BBG_FIRE_GODDESS_GEOTHERMAL_MODIFIER', 'Amount', 3);
INSERT INTO BeliefModifiers(BeliefType, ModifierID) VALUES
    ('BELIEF_GODDESS_OF_FIRE', 'BBG_FIRE_GODDESS_GEOTHERMAL_GIVER');
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ...
    ('BBG_GODS_OF_CRAFTSMEN_RESOURCES_MODIFIER', 'MODIFIER_SINGLE_CITY_ADJUST_EXTRA_ACCUMULATION', NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
...
-- 30/03/25 Religious community +6/12 gold per shrine/temple
-- 30/09/25: Reduced to +5/10 gold
