...
-- Move infantry card
-- 22/07/26 : new melee prod card + nerf grande armee
UPDATE Policies SET PrereqCivic='CIVIC_IDEOLOGY' WHERE PolicyType='POLICY_MILITARY_FIRST';
...
-- 22/07/26 : new melee prod card + nerf grande armee
DELETE FROM PolicyModifiers WHERE PolicyType='POLICY_GRANDE_ARMEE' AND ModifierId IN ('GRANDEARMEE_MODERN_MELEE_PRODUCTION', 'GRANDEARMEE_MODERN_ANTI_CAVALRY_PRODUCTION', 'GRANDEARMEE_MODERN_RANGED_PRODUCTION');

INSERT INTO Types (Type, Kind) VALUES
    ('BBG_MODERN_DRILL', 'KIND_POLICY');
INSERT INTO Policies (PolicyType, Name, Description, PrereqCivic, GovernmentSlotType) VALUES
    ('BBG_MODERN_DRILL', 'LOC_BBG_MODERN_DRILL_NAME', 'LOC_BBG_MODERN_DRILL_DESCRIPTION', 'CIVIC_MOBILIZATION', 'SLOT_MILITARY');
INSERT INTO PolicyModifiers (PolicyType, ModifierId) VALUES
    ('BBG_MODERN_DRILL', 'AGOGE_ANCIENT_MELEE_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'AGOGE_CLASSICAL_MELEE_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'FEUDALCONTRACT_MEDIEVAL_MELEE_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'FEUDALCONTRACT_RENAISSANCE_MELEE_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'GRANDEARMEE_INDUSTRIAL_MELEE_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'GRANDEARMEE_MODERN_MELEE_PRODUCTION'),

    ('BBG_MODERN_DRILL', 'AGOGE_ANCIENT_ANTI_CAVALRY_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'AGOGE_CLASSICAL_ANTI_CAVALRY_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'FEUDALCONTRACT_MEDIEVAL_ANTI_CAVALRY_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'FEUDALCONTRACT_RENAISSANCE_ANTI_CAVALRY_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'GRANDEARMEE_INDUSTRIAL_ANTI_CAVALRY_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'GRANDEARMEE_MODERN_ANTI_CAVALRY_PRODUCTION'),

    ('BBG_MODERN_DRILL', 'AGOGE_ANCIENT_RANGED_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'AGOGE_CLASSICAL_RANGED_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'FEUDALCONTRACT_MEDIEVAL_RANGED_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'FEUDALCONTRACT_RENAISSANCE_RANGED_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'GRANDEARMEE_INDUSTRIAL_RANGED_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'GRANDEARMEE_MODERN_RANGED_PRODUCTION'),
    
 
    ('BBG_MODERN_DRILL', 'BBG_AGOGE_ANCIENT_RECON_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'BBG_AGOGE_CLASSICAL_RECON_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'BBG_FEUDALCONTRACT_MEDIEVAL_RECON_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'BBG_FEUDALCONTRACT_RENAISSANCE_RECON_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'BBG_GRANDEARMEE_INDUSTRIAL_RECON_PRODUCTION'),
    ('BBG_MODERN_DRILL', 'BBG_GRANDEARMEE_MODERN_RECON_PRODUCTION');

DELETE FROM ObsoletePolicies WHERE PolicyType='POLICY_GRANDE_ARMEE' AND ObsoletePolicy='POLICY_MILITARY_FIRST';
INSERT INTO ObsoletePolicies (PolicyType, ObsoletePolicy) VALUES
    ('POLICY_GRANDE_ARMEE', 'BBG_MODERN_DRILL'),
    ('BBG_MODERN_DRILL', 'POLICY_MILITARY_FIRST');
...
-- 19/07/26 : naval test
INSERT INTO Types (Type, Kind) VALUES
    ('BBG_POLICY_NAVAL_GUILDS', 'KIND_POLICY');
INSERT INTO Policies (PolicyType, Name, Description, PrereqCivic, GovernmentSlotType) VALUES
    ('BBG_POLICY_NAVAL_GUILDS', 'LOC_POLICY_NAVAL_GUILDS_NAME', 'LOC_POLICY_NAVAL_GUILDS_DESCRIPTION', 'CIVIC_CIVIL_SERVICE', 'SLOT_MILITARY');
INSERT INTO PolicyModifiers (PolicyType, ModifierId) VALUES
    ('BBG_POLICY_NAVAL_GUILDS', 'MARITIMIEINDUSTRIES_ANCIENT_NAVAL_MELEE_PRODUCTION'),
    ('BBG_POLICY_NAVAL_GUILDS', 'MARITIMIEINDUSTRIES_ANCIENT_NAVAL_RAIDER_PRODUCTION'),
    ('BBG_POLICY_NAVAL_GUILDS', 'MARITIMIEINDUSTRIES_ANCIENT_NAVAL_RANGED_PRODUCTION'),

    ('BBG_POLICY_NAVAL_GUILDS', 'MARITIMIEINDUSTRIES_CLASSICAL_NAVAL_MELEE_PRODUCTION'),
    ('BBG_POLICY_NAVAL_GUILDS', 'MARITIMIEINDUSTRIES_CLASSICAL_NAVAL_RAIDER_PRODUCTION'),
    ('BBG_POLICY_NAVAL_GUILDS', 'MARITIMIEINDUSTRIES_CLASSICAL_NAVAL_RANGED_PRODUCTION'),
    
    ('BBG_POLICY_NAVAL_GUILDS', 'PRESSGANGS_MEDIEVAL_NAVAL_MELEE_PRODUCTION'),
    ('BBG_POLICY_NAVAL_GUILDS', 'PRESSGANGS_MEDIEVAL_NAVAL_RAIDER_PRODUCTION'),
    ('BBG_POLICY_NAVAL_GUILDS', 'PRESSGANGS_MEDIEVAL_NAVAL_RANGED_PRODUCTION'),
    
    ('BBG_POLICY_NAVAL_GUILDS', 'POLICY_SUK_JAHAZI_PRODUCTION');

INSERT INTO ObsoletePolicies (PolicyType, ObsoletePolicy) VALUES
    ('POLICY_MARITIME_INDUSTRIES', 'BBG_POLICY_NAVAL_GUILDS'),
    ('BBG_POLICY_NAVAL_GUILDS', 'POLICY_PRESS_GANGS'),
    ('BBG_POLICY_NAVAL_GUILDS', 'POLICY_INTERNATIONAL_WATERS');