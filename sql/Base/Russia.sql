...
-- 19/01/26 cities in tundra with a lavra receive +1 food
-- 16/03/26 and requires a shrine
-- 14/07/26 requires a temple
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_TOUNDRA_CITY_LAVRA_REQSET', 'REQUIREMENTSET_TEST_ALL'),
    ('BBG_TOUNDRA_HILLS_CITY_LAVRA_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_TOUNDRA_CITY_LAVRA_REQSET', 'REQUIRES_PLOT_HAS_TUNDRA'),
    ('BBG_TOUNDRA_CITY_LAVRA_REQSET', 'BBG_REQUIRES_PLOT_IS_CITY_CENTER'),
    ('BBG_TOUNDRA_CITY_LAVRA_REQSET', 'BBG_CITY_HAS_DISTRICT_LAVRA_REQUIREMENT'),
    ('BBG_TOUNDRA_CITY_LAVRA_REQSET', 'REQUIRES_CITY_HAS_TEMPLE'),
    ('BBG_TOUNDRA_HILLS_CITY_LAVRA_REQSET', 'REQUIRES_PLOT_HAS_TUNDRA_HILLS'),
    ('BBG_TOUNDRA_HILLS_CITY_LAVRA_REQSET', 'BBG_REQUIRES_PLOT_IS_CITY_CENTER'),
    ('BBG_TOUNDRA_HILLS_CITY_LAVRA_REQSET', 'BBG_CITY_HAS_DISTRICT_LAVRA_REQUIREMENT'),
    ('BBG_TOUNDRA_HILLS_CITY_LAVRA_REQSET', 'REQUIRES_CITY_HAS_TEMPLE');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_TOUNDRA_CITY_LAVRA_FOOD', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_TOUNDRA_CITY_LAVRA_REQSET'),
    ('BBG_TOUNDRA_HILLS_CITY_LAVRA_FOOD', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_TOUNDRA_HILLS_CITY_LAVRA_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_TOUNDRA_CITY_LAVRA_FOOD', 'YieldType', 'YIELD_FOOD'),
    ('BBG_TOUNDRA_CITY_LAVRA_FOOD', 'Amount', 1),
    ('BBG_TOUNDRA_HILLS_CITY_LAVRA_FOOD', 'YieldType', 'YIELD_FOOD'),
    ('BBG_TOUNDRA_HILLS_CITY_LAVRA_FOOD', 'Amount', 1);
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ('TRAIT_CIVILIZATION_MOTHER_RUSSIA', 'BBG_TOUNDRA_CITY_LAVRA_FOOD'),
    ('TRAIT_CIVILIZATION_MOTHER_RUSSIA', 'BBG_TOUNDRA_HILLS_CITY_LAVRA_FOOD');