...
INSERT INTO Modifiers(ModifierId, ModifierType, RunOnce, Permanent, OwnerRequirementSetId) VALUES
    ('BBG_MVEMBA_RELIC_GOVBUILDING_TALL', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 'PLAYER_HAS_GOV_BUILDING_TALL_REQUIREMENTS'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_WIDE', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 'PLAYER_HAS_GOV_BUILDING_WIDE_REQUIREMENTS'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_CONQUEST', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 'PLAYER_HAS_GOV_BUILDING_CONQUEST_REQUIREMENTS'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_FAITH', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 'PLAYER_HAS_GOV_BUILDING_FAITH_REQUIREMENTS'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_CITYSTATES', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 'PLAYER_HAS_GOV_BUILDING_CITYSTATES_REQUIREMENTS'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_SPIES', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 'PLAYER_HAS_GOV_BUILDING_SPIES_REQUIREMENTS'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_SCIENCE', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 'PLAYER_HAS_GOV_BUILDING_SCIENCE_REQUIREMENTS'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_CULTURE', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 'PLAYER_HAS_GOV_BUILDING_CULTURE_REQUIREMENTS'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_MILITARY', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 'PLAYER_HAS_GOV_BUILDING_MILITARY_REQUIREMENTS');

INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
    ('BBG_MVEMBA_RELIC_GOVBUILDING_TALL', 'Amount', '1'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_WIDE', 'Amount', '1'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_CONQUEST', 'Amount', '1'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_FAITH', 'Amount', '1'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_CITYSTATES', 'Amount', '1'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_SPIES', 'Amount', '1'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_SCIENCE', 'Amount', '1'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_CULTURE', 'Amount', '1'),
    ('BBG_MVEMBA_RELIC_GOVBUILDING_MILITARY', 'Amount', '1');

INSERT INTO TraitModifiers(TraitType, ModifierId) VALUES
    ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'BBG_MVEMBA_RELIC_GOVBUILDING_TALL'),
    ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'BBG_MVEMBA_RELIC_GOVBUILDING_WIDE'),
    ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'BBG_MVEMBA_RELIC_GOVBUILDING_CONQUEST'),
    ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'BBG_MVEMBA_RELIC_GOVBUILDING_FAITH'),
    ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'BBG_MVEMBA_RELIC_GOVBUILDING_CITYSTATES'),
    ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'BBG_MVEMBA_RELIC_GOVBUILDING_SPIES'),
    ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'BBG_MVEMBA_RELIC_GOVBUILDING_SCIENCE'),
    ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'BBG_MVEMBA_RELIC_GOVBUILDING_CULTURE'),
    ('TRAIT_LEADER_RELIGIOUS_CONVERT', 'BBG_MVEMBA_RELIC_GOVBUILDING_MILITARY');
