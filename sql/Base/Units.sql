...
--18/12/23 Medic to military science 
...
-- INSERT INTO Types (Type, Kind) VALUES
--     ('BBG_MEDIC_MOVEMENT_AOE_MELEE_ANTICAV_RANGE_ABILITY', 'CLASS_MELEE');
--     ('BBG_MEDIC_MOVEMENT_AOE_MELEE_ANTICAV_RANGE_ABILITY', 'CLASS_RANGED');
--     ('BBG_MEDIC_MOVEMENT_AOE_MELEE_ANTICAV_RANGE_ABILITY', 'CLASS_ANTI_CAVALRY');
-- INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
--     ('BBG_UNIT_IS_MELEE_RANGE_OR_ANTICAV_REQSET', 'REQUIREMENTSET_TEST_ANY');
-- INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
--     ('BBG_UNIT_IS_MELEE_RANGE_OR_ANTICAV_REQSET', 'REQUIREMENT_UNIT_IS_MELEE'),
--     ('BBG_UNIT_IS_MELEE_RANGE_OR_ANTICAV_REQSET', 'REQUIREMENT_UNIT_IS_RANGED'),
--     ('BBG_UNIT_IS_MELEE_RANGE_OR_ANTICAV_REQSET', 'REQUIREMENT_UNIT_IS_ANTI_CAV');
-- INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
--     ('BBG_MEDIC_MOVEMENT_AOE_MELEE_ANTICAV_RANGE', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', NULL),
--     ('BBG_MEDIC_MOVEMENT', 'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT', NULL);
-- INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
--     ('BBG_MEDIC_MOVEMENT_AOE_MELEE_ANTICAV_RANGE', 'AbilityType', 'BBG_MEDIC_MOVEMENT_AOE_MELEE_ANTICAV_RANGE_ABILITY'),
--     ('BBG_MEDIC_MOVEMENT', 'Amount', 1);
-- INSERT INTO UnitAbilities (UnitAbilityType, Name, Description, Inactive) VALUES
--     ('BBG_MEDIC_MOVEMENT_AOE_MELEE_ANTICAV_RANGE_ABILITY', 'LOC_BBG_MEDIC_MOVEMENT_AOE_MELEE_ANTICAV_RANGE_ABILITY_NAME', 'LOC_BBG_MEDIC_MOVEMENT_AOE_MELEE_ANTICAV_RANGE_ABILITY_DESC', 1);
-- INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
--     ('BBG_MEDIC_MOVEMENT_AOE_MELEE_ANTICAV_RANGE_ABILITY', 'BBG_MEDIC_MOVEMENT');
...
-- INSERT INTO UnitAbilityModifiers(UnitAbilityType, ModifierId) VALUES
--     ('BBG_ABILITY_SUPPORT_NAVAL_MELEE', 'BBG_ABILITY_SUPPORT_NAVAL_MELEE_GALLEY_MODIFIER'),
--     ('BBG_ABILITY_SUPPORT_NAVAL_MELEE', 'BBG_ABILITY_SUPPORT_NAVAL_MELEE_CARAVEL_MODIFIER');
-- INSERT INTO Modifiers(ModifierId, ModifierType, SubjectRequirementSetId) VALUES
--     ('BBG_ABILITY_SUPPORT_NAVAL_MELEE_GALLEY_MODIFIER', 'GRANT_STRENGTH_PER_ADJACENT_UNIT_TYPE', 'BBG_UNIT_IS_DEFENDER');
-- INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
--     ('BBG_ABILITY_SUPPORT_NAVAL_MELEE_GALLEY_MODIFIER', 'Amount', '2'),
--     ('BBG_ABILITY_SUPPORT_NAVAL_MELEE_GALLEY_MODIFIER', 'UnitType', 'UNIT_GALLEY');
-- INSERT INTO ModifierStrings(ModifierId, Context, Text) VALUES
--     ('BBG_ABILITY_SUPPORT_NAVAL_MELEE_GALLEY_MODIFIER', 'Preview', 'LOC_BBG_ABILITY_SUPPORT_NAVAL_MELEE_GALLEY_DESC');
-- INSERT INTO Modifiers(ModifierId, ModifierType, SubjectRequirementSetId) VALUES
--     ('BBG_ABILITY_SUPPORT_NAVAL_MELEE_CARAVEL_MODIFIER', 'GRANT_STRENGTH_PER_ADJACENT_UNIT_TYPE', 'BBG_UNIT_IS_DEFENDER');
-- INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
--     ('BBG_ABILITY_SUPPORT_NAVAL_MELEE_CARAVEL_MODIFIER', 'Amount', '2'),
--     ('BBG_ABILITY_SUPPORT_NAVAL_MELEE_CARAVEL_MODIFIER', 'UnitType', 'UNIT_CARAVEL');
-- INSERT INTO ModifierStrings(ModifierId, Context, Text) VALUES
--     ('BBG_ABILITY_SUPPORT_NAVAL_MELEE_CARAVEL_MODIFIER', 'Preview', 'LOC_BBG_ABILITY_SUPPORT_NAVAL_MELEE_CARAVEL_DESC');
