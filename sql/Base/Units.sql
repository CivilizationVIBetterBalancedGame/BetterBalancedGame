...
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ...
    ('BBG_RAM_MOVEMENT_NIHANG_REQSET', 'REQUIREMENTSET_TEST_ALL'),
...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ...
    ('BBG_RAM_MOVEMENT_NIHANG_REQSET', 'ADJACENT_UNIT_REQUIREMENT'),
    ('BBG_RAM_MOVEMENT_NIHANG_REQSET', 'REQUIREMENT_UNIT_IS_NIHANG'),
    ('BBG_RAM_MOVEMENT_NIHANG_REQSET', 'BBG_UNIT_IS_UP_TO_ERA_CLASSICAL'),
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId, SubjectStackLimit ) VALUES
    ...
    ('BBG_RAM_NIHANG_MOVEMENT', 'MODIFIER_PLAYER_UNITS_ADJUST_MOVEMENT', 'BBG_RAM_MOVEMENT_NIHANG_REQSET', 1),
...
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ...
    ('BBG_RAM_NIHANG_MOVEMENT', 'Amount', 1),
...
INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
    ...
    ('BBG_RAM_MOVEMENT_AOE_MELEE_ANTICAV_RANGE_ABILITY', 'BBG_RAM_NIHANG_MOVEMENT'),
...
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ...
    ('BBG_SIEGE_TOWER_MOVEMENT_NIHANG_REQSET', 'REQUIREMENTSET_TEST_ALL'),
...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ...
    ('BBG_SIEGE_TOWER_MOVEMENT_NIHANG_REQSET', 'ADJACENT_UNIT_REQUIREMENT'),
    ('BBG_SIEGE_TOWER_MOVEMENT_NIHANG_REQSET', 'REQUIREMENT_UNIT_IS_NIHANG'),
    ('BBG_SIEGE_TOWER_MOVEMENT_NIHANG_REQSET', 'BBG_UNIT_IS_UP_TO_ERA_CLASSICAL'),
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId, SubjectStackLimit ) VALUES
    ...
    ('BBG_SIEGE_TOWER_NIHANG_MOVEMENT', 'MODIFIER_PLAYER_UNITS_ADJUST_MOVEMENT', 'BBG_SIEGE_TOWER_MOVEMENT_NIHANG_REQSET', 1),
...
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ...
    ('BBG_SIEGE_TOWER_NIHANG_MOVEMENT', 'Amount', 1),
...
INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
    ...
    ('BBG_SIEGE_TOWER_MOVEMENT_AOE_MELEE_ANTICAV_RANGE_ABILITY', 'BBG_SIEGE_TOWER_NIHANG_MOVEMENT'),
