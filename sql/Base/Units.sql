...
-- 03/03/25 Modern Armor : Gets +1 movement.  and +5 when attacking outside of friendly territory
UPDATE Units SET BaseMoves=5 WHERE UnitType='UNIT_MODERN_ARMOR';
-- +5 when defending inside friendly territory
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ...
    ('BBG_UNIT_IS_ATTACKER_NOT_IN_FRIENDLY_REQSET', 'UNIT_IN_NOT_OWNER_TERRITORY_REQUIREMENT');
