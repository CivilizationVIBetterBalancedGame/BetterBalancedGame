...
-- 30/03/25 units are now obsolete when the next tech is unlocked (cant manage to make the sql work)
UPDATE Units SET MandatoryObsoleteTech='TECH_MACHINERY' WHERE UnitType='UNIT_SCOUT';
UPDATE Units SET MandatoryObsoleteTech='TECH_IRON_WORKING' WHERE UnitType='UNIT_WARRIOR';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_TACTICS' WHERE UnitType='UNIT_SWORDSMAN';
UPDATE Units SET MandatoryObsoleteTech='TECH_GUNPOWDER' WHERE UnitType='UNIT_MAN_AT_ARMS';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_SCIENCE' WHERE UnitType='UNIT_MUSKETMAN';
UPDATE Units SET MandatoryObsoleteTech='TECH_REPLACEABLE_PARTS' WHERE UnitType='UNIT_LINE_INFANTRY';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_TACTICS' WHERE UnitType='UNIT_SPEARMAN';
UPDATE Units SET MandatoryObsoleteTech='TECH_METAL_CASTING' WHERE UnitType='UNIT_PIKEMAN';
UPDATE Units SET MandatoryObsoleteTech='TECH_COMPOSITES' WHERE UnitType='UNIT_AT_CREW';
UPDATE Units SET MandatoryObsoleteTech='TECH_SATELLITES' WHERE UnitType='UNIT_INFANTRY';
UPDATE Units SET MandatoryObsoleteTech='TECH_ARCHERY' WHERE UnitType='UNIT_SLINGER';
UPDATE Units SET MandatoryObsoleteTech='TECH_MACHINERY' WHERE UnitType='UNIT_ARCHER';
...
UPDATE Units SET MandatoryObsoleteTech='TECH_CASTLES' WHERE UnitType='UNIT_HORSEMAN';
UPDATE Units SET MandatoryObsoleteTech='TECH_SYNTHETIC_MATERIALS' WHERE UnitType='UNIT_CAVALRY';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_ENGINEERING' WHERE UnitType='UNIT_CATAPULT';
UPDATE Units SET MandatoryObsoleteTech='TECH_METAL_CASTING' WHERE UnitType='UNIT_TREBUCHET';
UPDATE Units SET MandatoryObsoleteTech='TECH_STEEL' WHERE UnitType='UNIT_BOMBARD';
UPDATE Units SET MandatoryObsoleteTech='TECH_GUIDANCE_SYSTEMS' WHERE UnitType='UNIT_ARTILLERY';
UPDATE Units SET MandatoryObsoleteTech='TECH_GUIDANCE_SYSTEMS' WHERE UnitType='UNIT_ANTIAIR_GUN';
UPDATE Units SET MandatoryObsoleteTech='TECH_MACHINERY' WHERE UnitType='UNIT_BATTERING_RAM';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_SCIENCE' WHERE UnitType='UNIT_SIEGE_TOWER';
UPDATE Units SET MandatoryObsoleteTech='TECH_STIRRUPS' WHERE UnitType='UNIT_HEAVY_CHARIOT';
UPDATE Units SET MandatoryObsoleteTech='TECH_BALLISTICS' WHERE UnitType='UNIT_KNIGHT';


UPDATE Units SET MandatoryObsoleteTech='TECH_COMPOSITES' WHERE UnitType='UNIT_TANK';
UPDATE Units SET MandatoryObsoleteTech='TECH_CARTOGRAPHY' WHERE UnitType='UNIT_GALLEY';
UPDATE Units SET MandatoryObsoleteTech='TECH_SQUARE_RIGGING' WHERE UnitType='UNIT_QUADRIREME';
UPDATE Units SET MandatoryObsoleteTech='TECH_STEAM_POWER' WHERE UnitType='UNIT_CARAVEL';
UPDATE Units SET MandatoryObsoleteTech='TECH_COMBINED_ARMS' WHERE UnitType='UNIT_IRONCLAD';
UPDATE Units SET MandatoryObsoleteTech='TECH_ELECTRICITY' WHERE UnitType='UNIT_PRIVATEER';
UPDATE Units SET MandatoryObsoleteTech='TECH_REFINING' WHERE UnitType='UNIT_FRIGATE';
UPDATE Units SET MandatoryObsoleteTech='TECH_LASERS' WHERE UnitType='UNIT_BATTLESHIP';
UPDATE Units SET MandatoryObsoleteTech='TECH_TELECOMMUNICATIONS' WHERE UnitType='UNIT_SUBMARINE';
UPDATE Units SET MandatoryObsoleteTech='TECH_ADVANCED_FLIGHT' WHERE UnitType='UNIT_BIPLANE';
UPDATE Units SET MandatoryObsoleteTech='TECH_LASERS' WHERE UnitType='UNIT_FIGHTER';
UPDATE Units SET MandatoryObsoleteTech='TECH_STEALTH_TECHNOLOGY' WHERE UnitType='UNIT_BOMBER';
UPDATE Units SET MandatoryObsoleteTech='TECH_MACHINERY' WHERE UnitType='UNIT_EGYPTIAN_CHARIOT_ARCHER';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_TACTICS' WHERE UnitType='UNIT_GREEK_HOPLITE';
UPDATE Units SET MandatoryObsoleteTech='TECH_MACHINERY' WHERE UnitType='UNIT_SCYTHIAN_HORSE_ARCHER';
UPDATE Units SET MandatoryObsoleteTech='TECH_STIRRUPS' WHERE UnitType='UNIT_SUMERIAN_WAR_CART';
UPDATE Units SET MandatoryObsoleteTech='TECH_REPLACEABLE_PARTS' WHERE UnitType='UNIT_ENGLISH_REDCOAT';
UPDATE Units SET MandatoryObsoleteTech='TECH_ELECTRICITY' WHERE UnitType='UNIT_ENGLISH_SEADOG';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_SCIENCE' WHERE UnitType='UNIT_SPANISH_CONQUISTADOR';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_TACTICS' WHERE UnitType='UNIT_ROMAN_LEGION';
UPDATE Units SET MandatoryObsoleteTech='TECH_GUNPOWDER' WHERE UnitType='UNIT_JAPANESE_SAMURAI';
UPDATE Units SET MandatoryObsoleteTech='TECH_GUNPOWDER' WHERE UnitType='UNIT_NORWEGIAN_BERSERKER';
UPDATE Units SET MandatoryObsoleteTech='TECH_CARTOGRAPHY' WHERE UnitType='UNIT_NORWEGIAN_LONGSHIP';
UPDATE Units SET MandatoryObsoleteTech='TECH_SYNTHETIC_MATERIALS' WHERE UnitType='UNIT_RUSSIAN_COSSACK';
UPDATE Units SET MandatoryObsoleteTech='TECH_BALLISTICS' WHERE UnitType='UNIT_INDIAN_VARU';

UPDATE Units SET MandatoryObsoleteTech='TECH_BALLISTICS' WHERE UnitType='UNIT_ARABIAN_MAMLUK';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_TACTICS' WHERE UnitType='UNIT_KONGO_SHIELD_BEARER';
UPDATE Units SET MandatoryObsoleteTech='TECH_REPLACEABLE_PARTS' WHERE UnitType='UNIT_FRENCH_GARDE_IMPERIALE';
UPDATE Units SET MandatoryObsoleteTech='TECH_TELECOMMUNICATIONS' WHERE UnitType='UNIT_GERMAN_UBOAT';
UPDATE Units SET MandatoryObsoleteTech='TECH_LASERS' WHERE UnitType='UNIT_AMERICAN_P51';
UPDATE Units SET MandatoryObsoleteTech='TECH_LASERS' WHERE UnitType='UNIT_BRAZILIAN_MINAS_GERAES';
UPDATE Units SET MandatoryObsoleteTech='TECH_BALLISTICS' WHERE UnitType='UNIT_CHINESE_CROUCHING_TIGER';
UPDATE Units SET MandatoryObsoleteTech='TECH_IRON_WORKING' WHERE UnitType='UNIT_AZTEC_EAGLE_WARRIOR';
UPDATE Units SET MandatoryObsoleteTech='TECH_METAL_CASTING' WHERE UnitType='UNIT_KHMER_DOMREY';
UPDATE Units SET MandatoryObsoleteTech='TECH_REFINING' WHERE UnitType='UNIT_INDONESIAN_JONG';
UPDATE Units SET MandatoryObsoleteTech='TECH_COMBUSTION' WHERE UnitType='UNIT_POLISH_HUSSAR';
UPDATE Units SET MandatoryObsoleteTech='TECH_MACHINERY' WHERE UnitType='UNIT_NUBIAN_PITATI';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_TACTICS' WHERE UnitType='UNIT_MACEDONIAN_HYPASPIST';
UPDATE Units SET MandatoryObsoleteTech='TECH_STIRRUPS' WHERE UnitType='UNIT_MACEDONIAN_HETAIROI';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_TACTICS' WHERE UnitType='UNIT_PERSIAN_IMMORTAL';
UPDATE Units SET MandatoryObsoleteTech='TECH_SATELLITES' WHERE UnitType='UNIT_DIGGER';
UPDATE Units SET MandatoryObsoleteTech='TECH_METAL_CASTING' WHERE UnitType='UNIT_ZULU_IMPI';
UPDATE Units SET MandatoryObsoleteTech='TECH_ADVANCED_BALLISTICS' WHERE UnitType='UNIT_KOREAN_HWACHA';
UPDATE Units SET MandatoryObsoleteTech='TECH_PLASTICS' WHERE UnitType='UNIT_SCOTTISH_HIGHLANDER';
UPDATE Units SET MandatoryObsoleteTech='TECH_REFINING' WHERE UnitType='UNIT_DE_ZEVEN_PROVINCIEN';
UPDATE Units SET MandatoryObsoleteTech='TECH_BALLISTICS' WHERE UnitType='UNIT_MONGOLIAN_KESHIG';
UPDATE Units SET MandatoryObsoleteTech='TECH_GUNPOWDER' WHERE UnitType='UNIT_GEORGIAN_KHEVSURETI';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_SCIENCE' WHERE UnitType='UNIT_MAPUCHE_MALON_RAIDER';
UPDATE Units SET MandatoryObsoleteTech='TECH_MACHINERY' WHERE UnitType='UNIT_CREE_OKIHTCITAW';
UPDATE Units SET MandatoryObsoleteTech='TECH_PLASTICS' WHERE UnitType='UNIT_RANGER';

UPDATE Units SET MandatoryObsoleteTech='TECH_COMPUTERS' WHERE UnitType='UNIT_OBSERVATION_BALLOON';
UPDATE Units SET MandatoryObsoleteTech='TECH_COMBUSTION' WHERE UnitType='UNIT_MEDIC';
UPDATE Units SET MandatoryObsoleteTech='TECH_CHEMISTRY' WHERE UnitType='UNIT_PIKE_AND_SHOT';
UPDATE Units SET MandatoryObsoleteTech='TECH_RIFLING' WHERE UnitType='UNIT_SKIRMISHER';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_SCIENCE' WHERE UnitType='UNIT_COURSER';
UPDATE Units SET MandatoryObsoleteTech='TECH_COMBUSTION' WHERE UnitType='UNIT_CUIRASSIER';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_SCIENCE' WHERE UnitType='UNIT_HUNGARY_BLACK_ARMY';
UPDATE Units SET MandatoryObsoleteTech='TECH_SYNTHETIC_MATERIALS' WHERE UnitType='UNIT_HUNGARY_HUSZAR';
UPDATE Units SET MandatoryObsoleteTech='TECH_RIFLING' WHERE UnitType='UNIT_INCA_WARAKAQ';
UPDATE Units SET MandatoryObsoleteTech='TECH_BALLISTICS' WHERE UnitType='UNIT_MALI_MANDEKALU_CAVALRY';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_TACTICS' WHERE UnitType='UNIT_MAORI_TOA';
UPDATE Units SET MandatoryObsoleteTech='TECH_ELECTRICITY' WHERE UnitType='UNIT_OTTOMAN_BARBARY_CORSAIR';
UPDATE Units SET MandatoryObsoleteTech='TECH_CARTOGRAPHY' WHERE UnitType='UNIT_PHOENICIA_BIREME';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_SCIENCE' WHERE UnitType='UNIT_SULEIMAN_JANISSARY';
UPDATE Units SET MandatoryObsoleteTech='TECH_CHEMISTRY' WHERE UnitType='UNIT_SWEDEN_CAROLEAN';
UPDATE Units SET MandatoryObsoleteTech='TECH_COMBUSTION' WHERE UnitType='UNIT_AMERICAN_ROUGH_RIDER';
UPDATE Units SET MandatoryObsoleteTech='TECH_MACHINERY' WHERE UnitType='UNIT_MAYAN_HULCHE';
UPDATE Units SET MandatoryObsoleteTech='TECH_SYNTHETIC_MATERIALS' WHERE UnitType='UNIT_COLOMBIAN_LLANERO';
UPDATE Units SET MandatoryObsoleteTech='TECH_SQUARE_RIGGING' WHERE UnitType='UNIT_BYZANTINE_DROMON';
UPDATE Units SET MandatoryObsoleteTech='TECH_BALLISTICS' WHERE UnitType='UNIT_BYZANTINE_TAGMA';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_TACTICS' WHERE UnitType='UNIT_GAUL_GAESATAE';
UPDATE Units SET MandatoryObsoleteTech='TECH_BALLISTICS' WHERE UnitType='UNIT_VIETNAMESE_VOI_CHIEN';
UPDATE Units SET MandatoryObsoleteTech='TECH_MILITARY_SCIENCE' WHERE UnitType='UNIT_ETHIOPIAN_OROMO_CAVALRY';
UPDATE Units SET MandatoryObsoleteTech='TECH_IRON_WORKING' WHERE UnitType='UNIT_BABYLONIAN_SABUM_KIBITTUM';
UPDATE Units SET MandatoryObsoleteTech='TECH_STEAM_POWER' WHERE UnitType='UNIT_PORTUGUESE_NAU';

-- SELECT u2.PrereqTech FROM UnitUpgrades uu INNER JOIN Units u2 ON uu.UpgradeUnit = u2.UnitType;
-- SELECT Unit FROM UnitUpgrades WHERE Unit='UNIT_WARRIOR';
-- UPDATE Units
-- SET MandatoryObsoleteTech = (
--     SELECT u.PrereqTech
--     FROM UnitUpgrades uu
--     LEFT JOIN Units u ON uu.UpgradeUnit = u.UnitType
-- )
-- WHERE EXISTS (
--     SELECT 1
--     FROM UnitUpgrades uu
