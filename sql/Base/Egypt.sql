...
-- 19/01/26 Sphinx give food on plains and prod on grassland
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
    ('BBG_TILE_IS_GRASS', 'REQUIREMENT_PLOT_TERRAIN_TYPE_MATCHES'),
    ('BBG_TILE_IS_GRASS_HILLS', 'REQUIREMENT_PLOT_TERRAIN_TYPE_MATCHES'),
    ('BBG_TILE_IS_PLAINS', 'REQUIREMENT_PLOT_TERRAIN_TYPE_MATCHES'),
    ('BBG_TILE_IS_PLAINS_HILLS', 'REQUIREMENT_PLOT_TERRAIN_TYPE_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
    ('BBG_TILE_IS_GRASS', 'TerrainType', 'TERRAIN_GRASS'),
    ('BBG_TILE_IS_GRASS_HILLS', 'TerrainType', 'TERRAIN_GRASS_HILLS'),
    ('BBG_TILE_IS_PLAINS', 'TerrainType', 'TERRAIN_PLAINS'),
    ('BBG_TILE_IS_PLAINS_HILLS', 'TerrainType', 'TERRAIN_PLAINS_HILLS');
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_TILE_IS_GRASS_REQSET', 'REQUIREMENTSET_TEST_ALL'),
    ('BBG_TILE_IS_GRASS_HILLS_REQSET', 'REQUIREMENTSET_TEST_ALL'),
    ('BBG_TILE_IS_PLAINS_REQSET', 'REQUIREMENTSET_TEST_ALL'),
    ('BBG_TILE_IS_PLAINS_HILLS_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_TILE_IS_GRASS_REQSET', 'BBG_TILE_IS_GRASS'),
    ('BBG_TILE_IS_GRASS_HILLS_REQSET', 'BBG_TILE_IS_GRASS_HILLS'),
    ('BBG_TILE_IS_PLAINS_REQSET', 'BBG_TILE_IS_PLAINS'),
    ('BBG_TILE_IS_PLAINS_HILLS_REQSET', 'BBG_TILE_IS_PLAINS_HILLS');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_SPHINX_PROD_GRASS', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 'BBG_TILE_IS_GRASS_REQSET'),
    ('BBG_SPHINX_PROD_GRASS_HILLS', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 'BBG_TILE_IS_GRASS_HILLS_REQSET'),
    ('BBG_SPHINX_FOOD_PLAINS', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 'BBG_TILE_IS_PLAINS_REQSET'),
    ('BBG_SPHINX_FOOD_PLAINS_HILLS', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 'BBG_TILE_IS_PLAINS_HILLS_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_SPHINX_PROD_GRASS', 'YieldType', 'YIELD_PRODUCTION'),
    ('BBG_SPHINX_PROD_GRASS', 'Amount', 1),
    ('BBG_SPHINX_PROD_GRASS_HILLS', 'YieldType', 'YIELD_PRODUCTION'),
    ('BBG_SPHINX_PROD_GRASS_HILLS', 'Amount', 1),
    ('BBG_SPHINX_FOOD_PLAINS', 'YieldType', 'YIELD_FOOD'),
    ('BBG_SPHINX_FOOD_PLAINS', 'Amount', 1),
    ('BBG_SPHINX_FOOD_PLAINS_HILLS', 'YieldType', 'YIELD_FOOD'),
    ('BBG_SPHINX_FOOD_PLAINS_HILLS', 'Amount', 1);
INSERT OR IGNORE INTO ImprovementModifiers (ImprovementType , ModifierId) VALUES
    ('IMPROVEMENT_SPHINX', 'BBG_SPHINX_PROD_GRASS'),
    ('IMPROVEMENT_SPHINX', 'BBG_SPHINX_PROD_GRASS_HILLS'),
    ('IMPROVEMENT_SPHINX', 'BBG_SPHINX_FOOD_PLAINS'),
    ('IMPROVEMENT_SPHINX', 'BBG_SPHINX_FOOD_PLAINS_HILLS');
