...
INSERT OR IGNORE INTO RequirementSetRequirements ( RequirementSetId, RequirementId ) VALUES
    ...
    ( 'BBG_SPECIAL_DISTRICT_ON_COAST', 'REQUIRES_DISTRICT_IS_NOT_CITY_CENTER_BBG' ),
    ( 'BBG_SPECIAL_DISTRICT_ON_COAST', 'REQUIRES_DISTRICT_IS_NOT_AQUEDUCT_BBG' ),
    ( 'BBG_SPECIAL_DISTRICT_ON_COAST', 'REQUIRES_DISTRICT_IS_NOT_CANAL_BBG' ),
    ( 'BBG_SPECIAL_DISTRICT_ON_COAST', 'REQUIRES_DISTRICT_IS_NOT_DAM_BBG' ),
    ( 'BBG_SPECIAL_DISTRICT_ON_COAST', 'REQUIRES_DISTRICT_IS_NOT_NEIGHBORHOOD_BBG' ),
    ( 'BBG_SPECIAL_DISTRICT_ON_COAST', 'REQUIRES_DISTRICT_IS_NOT_SPACEPORT_BBG' ),
    ( 'BBG_SPECIAL_DISTRICT_ON_COAST', 'REQUIRES_DISTRICT_IS_NOT_WORLD_WONDER_BBG' );
