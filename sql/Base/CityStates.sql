...
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_HORSES_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_HORSES_RESOURCE_BONUS';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_IRON_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_IRON_RESOURCE_BONUS';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_NITER_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_NITER_RESOURCE_BONUS';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_COAL_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_COAL_RESOURCE_BONUS';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_OIL_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_OIL_RESOURCE_BONUS';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_ALUMINUM_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_ALUMINUM_RESOURCE_BONUS';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_URANIUM_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_URANIUM_RESOURCE_BONUS';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_HORSES_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_HORSES_RESOURCE_XP2';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_IRON_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_IRON_RESOURCE_XP2';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_NITER_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_NITER_RESOURCE_XP2';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_COAL_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_COAL_RESOURCE_XP2';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_OIL_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_OIL_RESOURCE_XP2';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_ALUMINUM_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_ALUMINUM_RESOURCE_XP2';
UPDATE Modifiers SET SubjectRequirementSetId='BBG_PLAYER_CAN_SEE_RESOURCE_URANIUM_REQSET' WHERE ModifierId='MINOR_CIV_HATTUSA_URANIUM_RESOURCE_XP2';
