...
--29/08/22 Missions gain housing if less than 10 tiles from cap
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_MISSION_DISTANCE_HOUSING', 'MODIFIER_SINGLE_CITY_ADJUST_IMPROVEMENT_HOUSING', 'BBG_IS_PLOT_WITHIN_10_TILES_FROM_CAPITAL_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_MISSION_DISTANCE_HOUSING', 'Amount', '1');
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_IS_PLOT_WITHIN_10_TILES_FROM_CAPITAL_REQUIREMENTS', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_IS_PLOT_WITHIN_10_TILES_FROM_CAPITAL_REQUIREMENTS', 'BBG_REQUIRES_OBJECT_WITHIN_10_TILES_FROM_CAPITAL');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
    ('BBG_REQUIRES_OBJECT_WITHIN_10_TILES_FROM_CAPITAL', 'REQUIREMENT_PLOT_NEAR_CAPITAL');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
    ('BBG_REQUIRES_OBJECT_WITHIN_10_TILES_FROM_CAPITAL', 'MinDistance', '1'),
    ('BBG_REQUIRES_OBJECT_WITHIN_10_TILES_FROM_CAPITAL', 'MaxDistance', '10');
...
--23/08/22 Missions requirement 10+ tiles from capital 
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
    ('BBG_REQUIRES_OBJECT_10_TILES_OR_MORE_FROM_CAPITAL', 'REQUIREMENT_PLOT_NEAR_CAPITAL');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
    ('BBG_REQUIRES_OBJECT_10_TILES_OR_MORE_FROM_CAPITAL', 'MinDistance', '10');
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
    ('BBG_IS_PLOT_10_TILES_OR_MORE_FROM_CAPITAL_REQUIREMENTS', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
    ('BBG_IS_PLOT_10_TILES_OR_MORE_FROM_CAPITAL_REQUIREMENTS', 'BBG_REQUIRES_OBJECT_10_TILES_OR_MORE_FROM_CAPITAL');
--23/08/22 Missions give prod and faith when 10+ tiles from cap
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_MISSION_DISTANCE_PRODUCTION', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 'BBG_IS_PLOT_10_TILES_OR_MORE_FROM_CAPITAL_REQUIREMENTS'),
    ('BBG_MISSION_DISTANCE_FAITH', 'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS', 'BBG_IS_PLOT_10_TILES_OR_MORE_FROM_CAPITAL_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
