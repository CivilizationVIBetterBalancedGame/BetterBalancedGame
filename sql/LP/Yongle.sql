...
UPDATE Project_YieldConversions SET PercentOfProductionRate=100 WHERE ProjectType='PROJECT_LIJIA_FOOD';
UPDATE Project_YieldConversions SET PercentOfProductionRate=100 WHERE ProjectType='PROJECT_LIJIA_FAITH';
UPDATE Project_YieldConversions SET PercentOfProductionRate=200 WHERE ProjectType='PROJECT_LIJIA_GOLD';