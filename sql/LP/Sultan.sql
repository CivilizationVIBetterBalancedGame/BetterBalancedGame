...
INSERT INTO TypeTags (Type, Tag) VALUES
    ...
    ('BBG_SULTAN_CS_FROM_APOSTLE_ABILITY', 'CLASS_RANGED'),
    ('BBG_SULTAN_CS_FROM_APOSTLE_ABILITY', 'CLASS_MELEE'),
    ('BBG_SULTAN_CS_FROM_APOSTLE_ABILITY', 'CLASS_HEAVY_CAVALRY'),
    ('BBG_SULTAN_CS_FROM_APOSTLE_ABILITY', 'CLASS_LIGHT_CAVALRY'),
    ('BBG_SULTAN_CS_FROM_APOSTLE_ABILITY', 'CLASS_SIEGE'),
    ('BBG_SULTAN_CS_FROM_APOSTLE_ABILITY', 'CLASS_RECON');
INSERT INTO UnitAbilities (UnitAbilityType, Name, Description, Inactive) VALUES
