...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES 
    ('BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_BONUS_RESOURCE', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_TILE_IS_FLOODPLAIN_BONUS_RESOURCE');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_BONUS_RESOURCE', 'YieldType', 'YIELD_CULTURE'),
    ('BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_BONUS_RESOURCE', 'Amount', '1');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES 
    ('BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_LUX_RESOURCE', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_TILE_IS_FLOODPLAIN_LUX_RESOURCE');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_LUX_RESOURCE', 'YieldType', 'YIELD_CULTURE'),
    ('BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_LUX_RESOURCE', 'Amount', '1');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES 
    ('BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_STRAT_RESOURCE', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'BBG_TILE_IS_FLOODPLAIN_STRAT_RESOURCE');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_STRAT_RESOURCE', 'YieldType', 'YIELD_CULTURE'),
    ('BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_STRAT_RESOURCE', 'Amount', '1');
...
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ('TRAIT_LEADER_RAMSES', 'BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_BONUS_RESOURCE'),
    ('TRAIT_LEADER_RAMSES', 'BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_STRAT_RESOURCE'),
    ('TRAIT_LEADER_RAMSES', 'BBG_RAMSES_FLOODPLAINS_RESOURCE_CULTURE_ON_LUX_RESOURCE'),
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_PTOLE_FASTER_THEATER_RIVER', 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION', 'PLOT_ADJACENT_TO_RIVER_REQUIREMENTS'),
    ('BBG_PTOLE_FASTER_HS_RIVER', 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION', 'PLOT_ADJACENT_TO_RIVER_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_PTOLE_FASTER_THEATER_RIVER', 'DistrictType', 'DISTRICT_THEATER'),
    ('BBG_PTOLE_FASTER_THEATER_RIVER', 'Amount', 15),
    ('BBG_PTOLE_FASTER_HS_RIVER', 'DistrictType', 'DISTRICT_HOLY_SITE'),
    ('BBG_PTOLE_FASTER_HS_RIVER', 'Amount', 15);
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ('TRAIT_LEADER_CLEOPATRA_ALT', 'BBG_PTOLE_FASTER_THEATER_RIVER'),
    ('TRAIT_LEADER_CLEOPATRA_ALT', 'BBG_PTOLE_FASTER_HS_RIVER');