...
INSERT INTO TypeTags (Type, Tag) VALUES
    ('BBG_CAESAR_XP_BONUS_BASE_ABILITY', 'CLASS_MELEE'),
    ('BBG_CAESAR_XP_BONUS_BASE_ABILITY', 'CLASS_SIEGE'),
    ('BBG_CAESAR_XP_BONUS_BASE_ABILITY', 'CLASS_HEAVY_CAVALRY');
...
-- 19/12/25 Removed the gold city/camp and the bonus combat against barbar
...
DELETE FROM TraitModifiers WHERE ModifierId IN ('TRAIT_CAESAR_GOLD_CAPTURED_CITY', 'TRAIT_CAESAR_GOLD_CAPTURED_CITY_MODIFIER', 'TRAIT_CAESAR_GOLD_CAPTURED_CITY_METAL_CASTING', 'TRAIT_CAESAR_GOLD_CAPTURED_CITY_STEEL', 'BARBARIAN_CAMP_GOLD_CAPTURED_CITY', 'BARBARIAN_CAMP_GOLD_CAPTURED_CITY_METAL_CASTING', 'BARBARIAN_CAMP_GOLD_CAPTURED_CITY_STEEL', 'TRAIT_CAESAR_BARB_COMBAT');
