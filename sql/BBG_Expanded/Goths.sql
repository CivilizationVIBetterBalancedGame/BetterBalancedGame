...
INSERT INTO Types(Type, Kind) VALUES
    ('NAMED_RIVER_GOTH_1', 'KIND_NAMED_RIVER'),
    ('NAMED_RIVER_GOTH_2', 'KIND_NAMED_RIVER'),
    ('NAMED_LAKE_GOTH_1', 'KIND_NAMED_LAKE'),
    ('NAMED_LAKE_GOTH_2', 'KIND_NAMED_LAKE'),
    ('NAMED_MOUNTAIN_GOTH_1', 'KIND_NAMED_MOUNTAIN'),
    ('NAMED_MOUNTAIN_GOTH_2', 'KIND_NAMED_MOUNTAIN'),
    ('NAMED_VOLCANO_GOTH_1', 'KIND_NAMED_VOLCANO'),
    ('NAMED_VOLCANO_GOTH_2', 'KIND_NAMED_VOLCANO'),
    ('NAMED_SEA_GOTH_1', 'KIND_NAMED_SEA'),
    ('NAMED_SEA_GOTH_2', 'KIND_NAMED_SEA');


INSERT INTO NamedRivers(NamedRiverType, Name) VALUES
    ('NAMED_RIVER_GOTH_1', 'LOC_NAMED_RIVER_GOTH_1_NAME'),
    ('NAMED_RIVER_GOTH_2', 'LOC_NAMED_RIVER_GOTH_2_NAME');
