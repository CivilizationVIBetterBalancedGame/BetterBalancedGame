...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ...
    ('BBG_SPEARTHROWER_TRADEROUTE_CONSULATE', 'MODIFIER_PLAYER_CITIES_ADJUST_TRADE_ROUTE_CAPACITY', 'BUILDING_IS_CONSULATE'),
...
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ...
    ('BBG_SPEARTHROWER_TRADEROUTE_CONSULATE', 'Amount', 1),
    ('BBG_SPEARTHROWER_TRADEROUTE_CHANCERY', 'Amount', 1);
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ('TRAIT_AGENDA_LIME_TEO_OWL_LORD_OF_WEST', 'BBG_SPEARTHROWER_TRADEROUTE_UD'),
    ('TRAIT_AGENDA_LIME_TEO_OWL_LORD_OF_WEST', 'BBG_SPEARTHROWER_TRADEROUTE_CONSULATE'),
    ('TRAIT_AGENDA_LIME_TEO_OWL_LORD_OF_WEST', 'BBG_SPEARTHROWER_TRADEROUTE_CHANCERY');

-- 14/07/26 +100% production toward diplomatic quarter buildings
 INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
    ('BBG_SPEARTHROWER_DIPLOMATIC_QUARTER_PRODUCTION', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
    ('BBG_SPEARTHROWER_DIPLOMATIC_QUARTER_PRODUCTION', 'DistrictType', 'DISTRICT_DIPLOMATIC_QUARTER'),
    ('BBG_SPEARTHROWER_DIPLOMATIC_QUARTER_PRODUCTION', 'Amount', 100);
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
    ('TRAIT_AGENDA_LIME_TEO_OWL_LORD_OF_WEST', 'BBG_SPEARTHROWER_DIPLOMATIC_QUARTER_PRODUCTION');
