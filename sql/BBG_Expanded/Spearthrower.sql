...
INSERT INTO Requirements(RequirementId, RequirementType) VALUES
    ('PLAYER_HAS_CS_FIRE_IS_BORN_CITY_FLAG_REQ', 'REQUIREMENT_PLOT_PROPERTY_MATCHES'),
    ('CITY_HAS_OWN_FIRE_IS_BORN_TRADEROUT_REQ', 'REQUIREMENT_PLOT_PROPERTY_MATCHES');
INSERT INTO RequirementArguments(RequirementId, Name, Value) VALUES
    ('PLAYER_HAS_CS_FIRE_IS_BORN_CITY_FLAG_REQ', 'PropertyName', 'FIRE_IS_BORN_ESTABLISHED_CS'),
    ('PLAYER_HAS_CS_FIRE_IS_BORN_CITY_FLAG_REQ', 'PropertyMinimum', '1'),
    ('CITY_HAS_OWN_FIRE_IS_BORN_TRADEROUT_REQ', 'PropertyName', 'TRADER_TO_FIRE_IS_BORN_CS'),
    ('CITY_HAS_OWN_FIRE_IS_BORN_TRADEROUT_REQ', 'PropertyMinimum', '1');
INSERT INTO RequirementSets(RequirementSetId, RequirementSetType) VALUES
    ('BBG_CITY_HAS_OWN_FIRE_IS_BORN_REQSET', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
    ('BBG_CITY_HAS_OWN_FIRE_IS_BORN_REQSET', 'PLAYER_HAS_CS_FIRE_IS_BORN_CITY_FLAG_REQ'),
    ('BBG_CITY_HAS_OWN_FIRE_IS_BORN_REQSET', 'CITY_HAS_OWN_FIRE_IS_BORN_TRADEROUT_REQ');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('BBG_DUPLICATE_ENVOY_IF_TRADER', 'MODIFIER_PLAYER_ADJUST_DUPLICATE_INFLUENCE_TOKEN_WHEN_TRADE_ROUTE_TO', 'BBG_CITY_HAS_OWN_FIRE_IS_BORN_REQSET');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
